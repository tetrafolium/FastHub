...
class IssueRepositoryProvider @Inject constructor(
    ...
    override fun getIssueByNumberSingle(repo: String, number: Int): Maybe<IssueModel> = dao.getIssueByNumberSingle(repo, number)
...
interface IssueRepository {
    ...
    fun getIssueByNumberSingle(repo: String, number: Int): Maybe<IssueModel>
