...
public interface ReviewService {
  ...
  getReview(@Path("owner") String owner, @Path("repo") String repo,
  ...
  getReviews(@Path("owner") String owner, @Path("repo") String repo,
  ...
  getReviewComments(@Path("owner") String owner, @Path("repo") String repo,
  ...
  @NonNull
  Observable<Pageable<ReviewCommentModel>>
  getPrReviewComments(@Path("owner") String owner, @Path("repo") String repo,
                      @Path("number") long number);
  ...
  submitComment(@Path("owner") String owner, @Path("repo") String repo,
  ...
  @Headers(
      ...
      + "application/vnd.github.squirrel-girl-preview")
  Observable<ReviewCommentModel>
  editComment(@Path("owner") String owner, @Path("repo") String repo,
  ...
  submitPrReview(@Path("owner") String owner, @Path("repo") String repo,
                 @Path("number") long number,
                 @NonNull @Body ReviewRequestModel body);
}
