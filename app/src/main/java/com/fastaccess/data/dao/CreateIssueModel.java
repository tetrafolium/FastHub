...
public class CreateIssueModel implements Parcelable {
  ...
  public static final Creator<CreateIssueModel> CREATOR =
      new Creator<CreateIssueModel>() {
        @Override
        public CreateIssueModel createFromParcel(final Parcel source) {
          return new CreateIssueModel(source);
        }

        @Override
        public CreateIssueModel[] newArray(final int size) {
