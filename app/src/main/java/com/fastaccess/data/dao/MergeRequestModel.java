...
public class MergeRequestModel implements Parcelable {
  ...
  protected MergeRequestModel(final Parcel in) {
  ...
  public static final Creator<MergeRequestModel> CREATOR =
      new Creator<MergeRequestModel>() {
        @Override
        public MergeRequestModel createFromParcel(final Parcel source) {
          return new MergeRequestModel(source);
        }

        @Override
        public MergeRequestModel[] newArray(final int size) {
