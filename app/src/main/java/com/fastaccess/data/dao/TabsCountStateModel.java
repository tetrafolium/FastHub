...
public class TabsCountStateModel implements Parcelable, Serializable {
  ...
  public void setTabIndex(final int tabIndex) { this.tabIndex = tabIndex; }
  ...
  public static final Creator<TabsCountStateModel> CREATOR =
      new Creator<TabsCountStateModel>() {
        @Override
        public TabsCountStateModel createFromParcel(final Parcel source) {
          return new TabsCountStateModel(source);
        }

        @Override
        public TabsCountStateModel[] newArray(final int size) {
