...
public abstract class AbstractPullRequest implements Parcelable {
  ...
  public static Disposable save(@NonNull List<PullRequest> models,
                                @NonNull String repoId, @NonNull String login) {
    return RxHelper
  ...
  getPullRequests(@NonNull String repoId, @NonNull String login,
  ...
  getPullRequestByNumber(int number, @NonNull String repoId,
  ...
  @NonNull
  public static SpannableBuilder getMergeBy(@NonNull PullRequest pullRequest,
