...
public abstract class AbstractRelease implements Parcelable {
  ...
  public static Disposable save(@NonNull List<Release> models,
  ...
  public static Completable delete(@NonNull String repoId,
  ...
  public static Single<List<Release>> get(@NonNull String repoId,
                                          @NonNull String login) {
    return App.getInstance()
        .getDataStore()
        .select(Release.class)
