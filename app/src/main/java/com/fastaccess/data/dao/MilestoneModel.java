...
public class MilestoneModel implements Parcelable {
  ...
  public static final Creator<MilestoneModel> CREATOR =
      new Creator<MilestoneModel>() {
        @Override
        public MilestoneModel createFromParcel(final Parcel source) {
          return new MilestoneModel(source);
        }

        @Override
        public MilestoneModel[] newArray(final int size) {
