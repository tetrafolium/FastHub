...
public abstract class AbstractComment implements Parcelable {
  ...
  public static Disposable saveForGist(final @NonNull List<Comment> models,
  ...
  public static Disposable saveForCommits(final @NonNull List<Comment> models,
  ...
  public static Single<List<Comment>> getGistComments(final
  ...
  public static Single<List<Comment>>
  getCommitComments(final @NonNull String repoId, final @NonNull String login,
                    final @NonNull String commitId) {
    return App.getInstance()
        .getDataStore()
        .select(Comment.class)
  ...
  public static Single<List<Comment>>
  getIssueComments(final @NonNull String repoId, final @NonNull String login,
  ...
  public static Single<List<Comment>>
  getPullRequestComments(final @NonNull String repoId,
                         final @NonNull String login,
