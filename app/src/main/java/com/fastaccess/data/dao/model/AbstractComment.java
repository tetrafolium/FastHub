...
public abstract class AbstractComment implements Parcelable {
  ...
  public static Disposable saveForGist(@NonNull List<Comment> models,
  ...
  public static Disposable saveForCommits(@NonNull List<Comment> models,
  ...
  getCommitComments(@NonNull String repoId, @NonNull String login,
                    @NonNull String commitId) {
    return App.getInstance()
        .getDataStore()
        .select(Comment.class)
  ...
  public static Single<List<Comment>>
  getIssueComments(@NonNull String repoId, @NonNull String login,
  ...
  public static Single<List<Comment>>
  getPullRequestComments(@NonNull String repoId, @NonNull String login,
