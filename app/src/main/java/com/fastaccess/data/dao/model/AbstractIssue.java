...
public abstract class AbstractIssue implements Parcelable {
  ...
  public static Disposable save(@NonNull List<Issue> models,
  ...
  public static Single<List<Issue>> getIssues(@NonNull String repoId,
  ...
  public static Observable<Issue> getIssueByNumber(int number, String repoId,
                                                   String login) {
    return App.getInstance()
        .getDataStore()
        .select(Issue.class)
