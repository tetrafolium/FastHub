...
public class LicenseModel implements Parcelable {
  ...
  public static final Creator<LicenseModel> CREATOR =
      new Creator<LicenseModel>() {
        @Override
        public LicenseModel createFromParcel(final Parcel source) {
          return new LicenseModel(source);
        }

        @Override
        public LicenseModel[] newArray(final int size) {
