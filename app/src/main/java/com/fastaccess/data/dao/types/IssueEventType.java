...
public enum IssueEventType {
  ...
  IssueEventType(final int iconResId) { this.iconResId = iconResId; }
  ...
  @Nullable
  public static IssueEventType getType(final @NonNull String type) {
    return Stream.of(values())
        .filter(value
                -> value.name().toLowerCase().equalsIgnoreCase(
