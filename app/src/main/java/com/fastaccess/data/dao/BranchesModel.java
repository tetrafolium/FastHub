...
public class BranchesModel implements Parcelable {
  ...
  public static final Creator<BranchesModel> CREATOR =
      new Creator<BranchesModel>() {
        @Override
        public BranchesModel createFromParcel(final Parcel source) {
          return new BranchesModel(source);
        }

        @Override
        public BranchesModel[] newArray(final int size) {
