...
public class RenameModel implements Parcelable {
  ...
  public static final Creator<RenameModel> CREATOR =
      new Creator<RenameModel>() {
        @Override
        public RenameModel createFromParcel(final Parcel source) {
          return new RenameModel(source);
        }

        @Override
        public RenameModel[] newArray(final int size) {
