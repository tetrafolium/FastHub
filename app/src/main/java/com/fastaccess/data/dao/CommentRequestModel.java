...
public class CommentRequestModel implements Parcelable {
  ...
  public boolean equals(final Object o) {
    ...
    return (path != null ? path.equals(that.path) : that.path == null) &&
        (position != null ? position.equals(that.position)
                          : that.position == null);
  }
  ...
  public String toString() {
    return "CommentRequestModel{"
        + "body='" + body + '\'' + ", inReplyTo=" + inReplyTo + ", path='" +
        path + '\'' + ", position=" + position + ", line=" + line + '}';
  }
  ...
  public static final Creator<CommentRequestModel> CREATOR =
      new Creator<CommentRequestModel>() {
        @Override
        public CommentRequestModel createFromParcel(final Parcel source) {
          return new CommentRequestModel(source);
        }

        @Override
        public CommentRequestModel[] newArray(final int size) {
