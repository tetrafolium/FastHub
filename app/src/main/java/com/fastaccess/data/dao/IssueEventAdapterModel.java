...
public class IssueEventAdapterModel implements Parcelable {
  ...
  public static ArrayList<IssueEventAdapterModel>
  addEvents(final @Nullable List<IssueEvent> modelList) {
    ...
    Stream.of(modelList).forEach(
        issueEventModel
        -> models.add(new IssueEventAdapterModel(ROW, issueEventModel)));
    return models;
  }
  ...
  public static final Creator<IssueEventAdapterModel> CREATOR =
      new Creator<IssueEventAdapterModel>() {
        @Override
        public IssueEventAdapterModel createFromParcel(final Parcel source) {
          return new IssueEventAdapterModel(source);
        }

        @Override
        public IssueEventAdapterModel[] newArray(final int size) {
