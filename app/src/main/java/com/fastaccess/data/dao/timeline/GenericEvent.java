...
public class GenericEvent implements Parcelable {
  ...
  public static final Creator<GenericEvent> CREATOR =
      new Creator<GenericEvent>() {
        @Override
        public GenericEvent createFromParcel(final Parcel source) {
          return new GenericEvent(source);
        }

        @Override
        public GenericEvent[] newArray(final int size) {
