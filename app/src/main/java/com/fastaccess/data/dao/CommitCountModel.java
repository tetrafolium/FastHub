...
public class CommitCountModel implements Parcelable {
  ...
  public static final Parcelable.Creator<CommitCountModel> CREATOR =
      new Parcelable.Creator<CommitCountModel>() {
        @Override
        public CommitCountModel createFromParcel(final Parcel source) {
          return new CommitCountModel(source);
        }

        @Override
        public CommitCountModel[] newArray(final int size) {
