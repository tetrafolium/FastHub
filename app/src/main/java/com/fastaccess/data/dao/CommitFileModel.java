...
public class CommitFileModel implements Parcelable {
  ...
  protected CommitFileModel(final Parcel in) {
  ...
  public static final Creator<CommitFileModel> CREATOR =
      new Creator<CommitFileModel>() {
        @Override
        public CommitFileModel createFromParcel(final Parcel source) {
          return new CommitFileModel(source);
        }

        @Override
        public CommitFileModel[] newArray(final int size) {
  ...
  public String toString() {
    return "CommitFileModel{"
        ...
        ", status='" + status + '\'' + ", additions=" + additions +
        ", deletions=" + deletions + ", changes=" + changes + ", blobUrl='" +
        blobUrl + '\'' + ", rawUrl='" + rawUrl + '\'' + ", contentsUrl='" +
        contentsUrl + '\'' + ", patch='" + patch + '\'' + '}';
  }
  ...
  public void setAdditions(final int additions) { this.additions = additions; }

  public int getDeletions() { return deletions; }

  public void setDeletions(final int deletions) { this.deletions = deletions; }

  public int getChanges() { return changes; }

  public void setChanges(final int changes) { this.changes = changes; }

  public String getBlobUrl() { return blobUrl; }

  public void setBlobUrl(final String blobUrl) { this.blobUrl = blobUrl; }

  public String getRawUrl() { return rawUrl; }

  public void setRawUrl(final String rawUrl) { this.rawUrl = rawUrl; }
  ...
  public void setPatch(final String patch) { this.patch = patch; }
}
