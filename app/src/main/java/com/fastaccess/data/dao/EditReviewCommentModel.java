...
@Getter
@Setter
public class EditReviewCommentModel implements Parcelable {
  ...
  private EditReviewCommentModel(final Parcel in) {
    ...
    this.commentModel =
        in.readParcelable(ReviewCommentModel.class.getClassLoader());
    this.inReplyTo = in.readLong();
  }

  public static final Creator<EditReviewCommentModel> CREATOR =
      new Creator<EditReviewCommentModel>() {
        @Override
        public EditReviewCommentModel createFromParcel(final Parcel source) {
          return new EditReviewCommentModel(source);
        }

        @Override
        public EditReviewCommentModel[] newArray(final int size) {
