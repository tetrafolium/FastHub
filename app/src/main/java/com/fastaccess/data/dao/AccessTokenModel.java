...
public class AccessTokenModel implements Parcelable {
  ...
  public static final Creator<AccessTokenModel> CREATOR =
      new Creator<AccessTokenModel>() {
        @Override
        public AccessTokenModel createFromParcel(final Parcel source) {
          return new AccessTokenModel(source);
        }

        @Override
        public AccessTokenModel[] newArray(final int size) {
