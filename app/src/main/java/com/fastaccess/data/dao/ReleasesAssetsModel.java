...
public class ReleasesAssetsModel implements Parcelable {
  ...
  protected ReleasesAssetsModel(final Parcel in) {
  ...
  public static final Creator<ReleasesAssetsModel> CREATOR =
      new Creator<ReleasesAssetsModel>() {
        @Override
        public ReleasesAssetsModel createFromParcel(final Parcel source) {
          return new ReleasesAssetsModel(source);
        }

        @Override
        public ReleasesAssetsModel[] newArray(final int size) {
