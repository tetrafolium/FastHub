...
public class ProUsersModel implements Parcelable {
  ...
  public void setBlocked(final boolean blocked) { isBlocked = blocked; }

  @Override
  public String toString() {
    return "ProUsersModel{"
        + ", count=" + count + ", allowed=" + allowed + ", type=" + type + '}';
  }
  ...
  public static final Creator<ProUsersModel> CREATOR =
      new Creator<ProUsersModel>() {
        @Override
        public ProUsersModel createFromParcel(final Parcel source) {
          return new ProUsersModel(source);
        }

        @Override
        public ProUsersModel[] newArray(final int size) {
