...
public abstract class AbstractGist implements Parcelable {
  ...
  public static Disposable save(@NonNull List<Gist> models,
  ...
  @NonNull
  public static Single<List<Gist>> getMyGists(@NonNull String ownerName) {
  ...
  @NonNull
  public SpannableBuilder getDisplayTitle(boolean isFromProfile) {
