...
public class CommitLinesModel implements Parcelable {
  ...
  @NonNull
  public static List<CommitLinesModel> getLines(@Nullable String text) {
    ...
    if (!InputHelper.isEmpty(text)) {
      ...
      if (split.length > 1) {
        ...
        for (String token : split) {
          ...
          models.add(new CommitLinesModel(
              token, color,
              token.startsWith("@@") || !addLeft ? -1 : leftLineNo,
              token.startsWith("@@") || !addRight ? -1 : rightLineNo,
              index != -1, position, false));
        }
      }
    }
    return models;
  ...
  public static final Creator<CommitLinesModel> CREATOR =
      new Creator<CommitLinesModel>() {
        @Override
        ...
        @Override
        public CommitLinesModel[] newArray(int size) {
  ...
  public void setLeftLineNo(int leftLineNo) { this.leftLineNo = leftLineNo; }
  ...
  public boolean isNoNewLine() { return noNewLine; }

  public void setNoNewLine(boolean noNewLine) { this.noNewLine = noNewLine; }

  public int getPosition() { return position; }

  public void setPosition(int position) { this.position = position; }

  public boolean isHasCommentedOn() { return hasCommentedOn; }
