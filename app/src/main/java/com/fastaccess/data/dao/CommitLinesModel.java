...
public class CommitLinesModel implements Parcelable {
  ...
  @NonNull
  public static List<CommitLinesModel> getLines(final @Nullable String text) {
  ...
  public static final Creator<CommitLinesModel> CREATOR =
      new Creator<CommitLinesModel>() {
        @Override
        public CommitLinesModel createFromParcel(final Parcel source) {
          return new CommitLinesModel(source);
        }

        @Override
        public CommitLinesModel[] newArray(final int size) {
