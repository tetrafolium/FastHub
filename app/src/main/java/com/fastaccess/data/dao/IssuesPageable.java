...
public class IssuesPageable<M> implements Parcelable {
  ...
  protected IssuesPageable(final Parcel in) {
  ...
  public static final Creator<IssuesPageable> CREATOR =
      new Creator<IssuesPageable>() {
        @Override
        public IssuesPageable createFromParcel(final Parcel source) {
          return new IssuesPageable(source);
        }

        @Override
        public IssuesPageable[] newArray(final int size) {
