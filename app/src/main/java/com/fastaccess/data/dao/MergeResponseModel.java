...
public class MergeResponseModel implements Parcelable {
  ...
  protected MergeResponseModel(final Parcel in) {
  ...
  public static final Creator<MergeResponseModel> CREATOR =
      new Creator<MergeResponseModel>() {
        @Override
        public MergeResponseModel createFromParcel(final Parcel source) {
          return new MergeResponseModel(source);
        }

        @Override
        public MergeResponseModel[] newArray(final int size) {
