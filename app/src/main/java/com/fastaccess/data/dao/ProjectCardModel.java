...
public class ProjectCardModel implements Parcelable {
  ...
  public static final Creator<ProjectCardModel> CREATOR =
      new Creator<ProjectCardModel>() {
        @Override
        public ProjectCardModel createFromParcel(final Parcel source) {
          return new ProjectCardModel(source);
        }

        @Override
        public ProjectCardModel[] newArray(final int size) {
