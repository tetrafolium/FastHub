...
@Entity
@NoArgsConstructor
public class AbstractPinnedIssues {
  ...
  @Nullable
  public static PinnedIssues get(long issueId) {
    return App.getInstance()
        .getDataStore()
        .select(PinnedIssues.class)
  ...
  @NonNull
  public static Disposable updateEntry(long issueId) {
    return RxHelper
  ...
  @NonNull
  public static Single<List<Issue>> getMyPinnedIssues() {
    return App.getInstance()
        .getDataStore()
        .select(PinnedIssues.class)
  ...
  public static boolean isPinned(long issueId) { return get(issueId) != null; }
}
