...
public class CommentEvent implements Parcelable {
  ...
  public String toString() {
    return "CommentEvent{"
        + "id=" + id + ", user=" + user + ", url='" + url + '\'' + ", body='" +
        body + '\'' + ", bodyHtml='" + bodyHtml + '\'' + ", htmlUrl='" +
        htmlUrl + '\'' + ", createdAt=" + createdAt +
        ", updatedAt=" + updatedAt + ", position=" + position +
        ", line=" + line + ", path='" + path + '\'' + ", commitId='" +
        commitId + '\'' + ", repoId='" + repoId + '\'' + ", login='" + login +
        '\'' + ", gistId='" + gistId + '\'' + ", issueId='" + issueId + '\'' +
  ...
  public static final Creator<CommentEvent> CREATOR =
      new Creator<CommentEvent>() {
        @Override
        public CommentEvent createFromParcel(final Parcel source) {
          return new CommentEvent(source);
        }

        @Override
        public CommentEvent[] newArray(final int size) {
