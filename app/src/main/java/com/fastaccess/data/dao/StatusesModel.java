...
public class StatusesModel implements Parcelable {
  ...
  public static final Creator<StatusesModel> CREATOR =
      new Creator<StatusesModel>() {
        @Override
        public StatusesModel createFromParcel(final Parcel source) {
          return new StatusesModel(source);
        }

        @Override
        public StatusesModel[] newArray(final int size) {
