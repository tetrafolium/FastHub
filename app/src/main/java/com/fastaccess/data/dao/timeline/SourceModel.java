...
public class SourceModel implements Parcelable {
  ...
  public static final Creator<SourceModel> CREATOR =
      new Creator<SourceModel>() {
        @Override
        public SourceModel createFromParcel(final Parcel source) {
          return new SourceModel(source);
        }

        @Override
        public SourceModel[] newArray(final int size) {
