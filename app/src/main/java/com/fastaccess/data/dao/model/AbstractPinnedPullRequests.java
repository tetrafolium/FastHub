...
public class AbstractPinnedPullRequests {
  ...
  @Nullable
  public static PinnedPullRequests get(final long pullRequestId) {
    return App.getInstance()
        .getDataStore()
        .select(PinnedPullRequests.class)
  ...
  public static void delete(final long pullRequestId) {
    App.getInstance()
        .getDataStore()
        .delete(PinnedPullRequests.class)
        .where(PinnedPullRequests.PULL_REQUEST_ID.eq(pullRequestId))
        .get()
        .value();
  }
  ...
  @NonNull
  public static Disposable updateEntry(final @NonNull long pullRequestId) {
    return RxHelper
