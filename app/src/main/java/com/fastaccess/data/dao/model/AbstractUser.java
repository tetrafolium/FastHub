...
public abstract class AbstractUser implements Parcelable {
  ...
  public static Disposable saveUserFollowerList(final
                                                @NonNull List<User> models,
                                                final
  ...
  public static Disposable saveUserFollowingList(final
                                                 @NonNull List<User> models,
                                                 final
  ...
  getUserFollowerList(final @NonNull String following) {
    return App.getInstance()
        .getDataStore()
        .select(User.class)
  ...
  @NonNull
  public static Single<List<User>>
  getUserFollowingList(final @NonNull String follower) {
    return App.getInstance()
        .getDataStore()
        .select(User.class)
