...
public abstract class AbstractUser implements Parcelable {
  ...
  public static Disposable saveUserFollowerList(@NonNull List<User> models,
                                                @NonNull String followingName) {
    return RxHelper
  ...
  public static Disposable saveUserFollowingList(@NonNull List<User> models,
                                                 @NonNull String followerName) {
    return RxHelper
        .getSingle(Single.fromPublisher(s -> {
          try {
            Login login = Login.getUser();
  ...
  @NonNull
  public static Single<List<User>>
  getUserFollowerList(@NonNull String following) {
    return App.getInstance()
        .getDataStore()
        .select(User.class)
  ...
  @NonNull
  public static Single<List<User>>
  getUserFollowingList(@NonNull String follower) {
    return App.getInstance()
        .getDataStore()
        .select(User.class)
