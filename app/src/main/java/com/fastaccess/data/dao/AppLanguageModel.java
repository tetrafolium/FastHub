...
public class AppLanguageModel implements Parcelable {
  ...
  public static final Parcelable.Creator<AppLanguageModel> CREATOR =
      new Parcelable.Creator<AppLanguageModel>() {
        @Override
        public AppLanguageModel createFromParcel(final Parcel source) {
          return new AppLanguageModel(source);
        }

        @Override
        public AppLanguageModel[] newArray(final int size) {
