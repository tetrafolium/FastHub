...
public abstract class AbstractRepoFile implements Parcelable {
  ...
  public static Observable<RepoFile> save(final @NonNull List<RepoFile> models,
                                          final @NonNull String login,
                                          final @NonNull String repoId) {
    ReactiveEntityStore<Persistable> singleEntityStore =
  ...
  public static Single<List<RepoFile>> getFiles(final @NonNull String login,
                                                final @NonNull String repoId) {
  ...
  public static Observable<RepoFile> getFile(final @NonNull String login,
                                             final @NonNull String repoId,
  ...
  public static final Creator<RepoFile> CREATOR = new Creator<RepoFile>() {
    @Override
    public RepoFile createFromParcel(final Parcel source) {
      return new RepoFile(source);
    }

    @Override
    public RepoFile[] newArray(final int size) {
