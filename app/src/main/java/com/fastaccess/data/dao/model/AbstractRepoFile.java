...
public abstract class AbstractRepoFile implements Parcelable {
  ...
  public static Observable<RepoFile> save(@NonNull List<RepoFile> models,
  ...
  public static Single<List<RepoFile>> getFiles(@NonNull String login,
                                                @NonNull String repoId) {
  ...
  public static Observable<RepoFile>
  getFile(@NonNull String login, @NonNull String repoId, @NonNull String sha) {
    return App.getInstance()
        .getDataStore()
        .select(RepoFile.class)
