...
public class LanguageColorModel implements Parcelable {
  ...
  public static final Parcelable.Creator<LanguageColorModel> CREATOR =
      new Parcelable.Creator<LanguageColorModel>() {
        @Override
        public LanguageColorModel createFromParcel(final Parcel source) {
          return new LanguageColorModel(source);
        }

        @Override
        public LanguageColorModel[] newArray(final int size) {
