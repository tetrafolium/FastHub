...
public abstract class AbstractIssueEvent implements Parcelable {
  ...
  public static Disposable save(@NonNull List<IssueEvent> models,
  ...
  public static Single<List<IssueEvent>>
  get(@NonNull String repoId, @NonNull String login, @NonNull String issueId) {
