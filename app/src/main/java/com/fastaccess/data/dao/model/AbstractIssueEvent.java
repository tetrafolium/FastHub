...
public abstract class AbstractIssueEvent implements Parcelable {
  ...
  public static Disposable save(final @NonNull List<IssueEvent> models,
          ...
          try {
            ...
            if (!models.isEmpty()) {
              for (IssueEvent issueEventModel : models) {
                dataSource.delete(IssueEvent.class)
                    .where(IssueEvent.ID.eq(issueEventModel.getId()))
                    .get()
                    .value();
  ...
  public static Single<List<IssueEvent>> get(final @NonNull String repoId,
                                             final @NonNull String login,
                                             final @NonNull String issueId) {
  ...
  public static final Creator<IssueEvent> CREATOR = new Creator<IssueEvent>() {
    @Override
    public IssueEvent createFromParcel(final Parcel source) {
      return new IssueEvent(source);
    }

    @Override
    public IssueEvent[] newArray(final int size) {
