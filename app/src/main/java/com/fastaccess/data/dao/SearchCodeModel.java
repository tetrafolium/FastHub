...
public class SearchCodeModel implements Parcelable {
  ...
  public static final Creator<SearchCodeModel> CREATOR =
      new Creator<SearchCodeModel>() {
        @Override
        public SearchCodeModel createFromParcel(final Parcel source) {
          return new SearchCodeModel(source);
        }

        @Override
        public SearchCodeModel[] newArray(final int size) {
