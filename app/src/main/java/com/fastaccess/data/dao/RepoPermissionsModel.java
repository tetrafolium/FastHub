...
public class RepoPermissionsModel implements Parcelable {
  ...
  public static final Creator<RepoPermissionsModel> CREATOR =
      new Creator<RepoPermissionsModel>() {
        @Override
        public RepoPermissionsModel createFromParcel(final Parcel source) {
          return new RepoPermissionsModel(source);
        }

        @Override
        public RepoPermissionsModel[] newArray(final int size) {
