...
public class NotificationSubjectModel implements Parcelable {
  ...
  public String toString() {
    return "NotificationSubjectModel{"
        + ", title='" + title + '\'' + ", url='" + url + '\'' + ", type='" +
        type + '\'' + ", latestCommentUrl='" + latestCommentUrl + '\'' + '}';
  }
  ...
  public static final Creator<NotificationSubjectModel> CREATOR =
      new Creator<NotificationSubjectModel>() {
        @Override
        public NotificationSubjectModel createFromParcel(final Parcel source) {
          return new NotificationSubjectModel(source);
        }

        @Override
        public NotificationSubjectModel[] newArray(final int size) {
