...
public class ReviewCommentModel implements Parcelable {
  ...
  public void setDiffHunk(final String diffHunk) { this.diffHunk = diffHunk; }
  ...
  public static final Creator<ReviewCommentModel> CREATOR =
      new Creator<ReviewCommentModel>() {
        @Override
        public ReviewCommentModel createFromParcel(final Parcel source) {
          return new ReviewCommentModel(source);
        }

        @Override
        public ReviewCommentModel[] newArray(final int size) {
