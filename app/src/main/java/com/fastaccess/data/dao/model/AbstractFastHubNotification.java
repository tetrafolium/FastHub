...
public class AbstractFastHubNotification implements Parcelable {
  ...
  public String toString() {
    return "AbstractFastHubNotification{"
        + "date=" + date + ", isRead=" + read + ", body='" + body + '\'' +
  ...
  public static final Creator<FastHubNotification> CREATOR =
      new Creator<FastHubNotification>() {
        @Override
        public FastHubNotification createFromParcel(final Parcel source) {
          return new FastHubNotification(source);
        }

        @Override
        public FastHubNotification[] newArray(final int size) {
