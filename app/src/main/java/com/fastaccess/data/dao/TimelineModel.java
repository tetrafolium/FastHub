...
public class TimelineModel implements Parcelable {
  ...
  public TimelineModel(final Issue issue) { this.issue = issue; }
  ...
  @NonNull
  public static Observable<List<TimelineModel>>
  construct(final @Nullable List<Comment> comments) {
  ...
  public boolean equals(final Object o) {
    ...
    return (comment != null && model.getComment() != null) &&
        (comment.getId() == model.comment.getId());
  }
  ...
  public void setEvent(final IssueEventType event) { this.event = event; }

  public Comment getComment() { return comment; }

  public void setComment(final Comment comment) { this.comment = comment; }

  public GenericEvent getGenericEvent() { return genericEvent; }

  public void setGenericEvent(final GenericEvent genericEvent) {
    this.genericEvent = genericEvent;
  }

  public PullRequestStatusModel getStatus() { return status; }
  ...
  public void setIssue(final Issue issue) { this.issue = issue; }
  ...
  public ReviewModel getReview() { return review; }

  public void setReview(final ReviewModel review) { this.review = review; }
  ...
  public void
  setGroupedReviewModel(final GroupedReviewModel groupedReviewModel) {
    this.groupedReviewModel = groupedReviewModel;
  }

  public PullRequestCommitModel getCommit() { return commit; }
  ...
  protected TimelineModel(final Parcel in) {
    ...
    this.status =
        in.readParcelable(PullRequestStatusModel.class.getClassLoader());
    ...
    this.groupedReviewModel =
        in.readParcelable(GroupedReviewModel.class.getClassLoader());
    this.commit =
        in.readParcelable(PullRequestCommitModel.class.getClassLoader());
    this.position = in.readInt();
  }

  public static final Creator<TimelineModel> CREATOR =
      new Creator<TimelineModel>() {
        @Override
        public TimelineModel createFromParcel(final Parcel source) {
          return new TimelineModel(source);
        }

        @Override
        public TimelineModel[] newArray(final int size) {
