...
public class TimelineModel implements Parcelable {
  ...
  public TimelineModel(Issue issue) { this.issue = issue; }
  ...
  construct(@Nullable List<Comment> comments) {
  ...
  public void setStatus(PullRequestStatusModel status) { this.status = status; }
  ...
  public void setReview(ReviewModel review) { this.review = review; }
  ...
  public void setCommit(PullRequestCommitModel commit) { this.commit = commit; }
