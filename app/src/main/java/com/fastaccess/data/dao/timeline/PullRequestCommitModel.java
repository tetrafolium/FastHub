...
public class PullRequestCommitModel implements Parcelable {
  ...
  public static final Creator<PullRequestCommitModel> CREATOR =
      new Creator<PullRequestCommitModel>() {
        @Override
        public PullRequestCommitModel createFromParcel(final Parcel source) {
          return new PullRequestCommitModel(source);
        }

        @Override
        public PullRequestCommitModel[] newArray(final int size) {
