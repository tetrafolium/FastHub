...
public class FilterOptionsModel implements Parcelable {
  ...
  private List<String> typesListForPersonalProfile =
      Stream.of("Select", "All", "Owner", "Public", "Private", "Member")
          .toList();
  private List<String> typesListForExternalProfile =
      Stream.of("Select", "All", "Owner", "Member").toList();
  private List<String> typesListForOrganizationProfile =
      Stream
          .of("Select", "All", "Public", "Private", "Forks", "Sources",
              "Member")
          .toList();
  private List<String> sortOptionsList =
      Stream.of("Pushed", "Created", "Updated", "Full Name").toList();
  private List<String> sortDirectionList =
      Stream.of("Descending", "Ascending").toList();
  ...
  public void setSort(final String sort) { this.sort = sort; }
  ...
  public List<String> getSortOptionList() { return sortOptionsList; }

  public List<String> getSortDirectionList() { return sortDirectionList; }

  public void setIsPersonalProfile(final boolean isPersonalProfile) {
    this.isPersonalProfile = isPersonalProfile;
  }

  public void setOrg(final boolean org) { this.isOrg = org; }

  public boolean isOrg() { return isOrg; }
  ...
  public static final Creator<FilterOptionsModel> CREATOR =
      new Creator<FilterOptionsModel>() {
        @Override
        public FilterOptionsModel createFromParcel(final Parcel source) {
          return new FilterOptionsModel(source);
        }

        @Override
        public FilterOptionsModel[] newArray(final int size) {
