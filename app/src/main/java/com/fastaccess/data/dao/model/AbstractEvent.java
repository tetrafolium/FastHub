...
public abstract class AbstractEvent implements Parcelable {
  ...
  save(@androidx.annotation.Nullable List<Event> events,
       @androidx.annotation.Nullable String user) {
    return RxHelper
  ...
  @NonNull
  public static Single<List<Event>> getEvents(@NonNull String login) {
