...
public class SlackResponseModel implements Parcelable {
  ...
  public static final Parcelable.Creator<SlackResponseModel> CREATOR =
      new Parcelable.Creator<SlackResponseModel>() {
        @Override
        public SlackResponseModel createFromParcel(final Parcel source) {
          return new SlackResponseModel(source);
        }

        @Override
        public SlackResponseModel[] newArray(final int size) {
