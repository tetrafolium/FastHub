...
public abstract class AbstractRepo implements Parcelable {
  ...
  public static Maybe<Repo> getRepo(final @NonNull String name,
  ...
  public static Disposable saveStarred(final @NonNull List<Repo> models,
                                       final @NonNull String starredUser) {
    return RxHelper
  ...
  public static Disposable saveMyRepos(final @NonNull List<Repo> models,
                                       final @NonNull String reposOwner) {
    return RxHelper
        .getSingle(Single.fromPublisher(s -> {
          try {
            Login login = Login.getUser();
  ...
  public static Single<List<Repo>> getStarred(final
                                              @NonNull String starredUser) {
    return App.getInstance()
        .getDataStore()
        .select(Repo.class)
        .where(STARRED_USER.eq(starredUser))
  ...
  public static Single<List<Repo>> getMyRepos(final
  ...
  protected AbstractRepo(final Parcel in) {
    ...
    this.permissions =
        in.readParcelable(RepoPermissionsModel.class.getClassLoader());
  ...
  public static final Creator<Repo> CREATOR = new Creator<Repo>() {
    @Override
    public Repo createFromParcel(final Parcel source) {
      return new Repo(source);
    }

    @Override
    public Repo[] newArray(final int size) {
