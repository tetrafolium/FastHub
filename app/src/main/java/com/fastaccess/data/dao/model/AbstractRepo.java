...
public abstract class AbstractRepo implements Parcelable {
  ...
  public static Maybe<Repo> getRepo(@NonNull String name,
  ...
  public static Disposable saveStarred(@NonNull List<Repo> models,
  ...
  public static Disposable saveMyRepos(@NonNull List<Repo> models,
