...
public class ProjectColumnModel implements Parcelable {
  ...
  public String getCardsUrl() { return cardsUrl; }

  public void setCardsUrl(final String cardsUrl) { this.cardsUrl = cardsUrl; }
  ...
  public static final Creator<ProjectColumnModel> CREATOR =
      new Creator<ProjectColumnModel>() {
        @Override
        public ProjectColumnModel createFromParcel(final Parcel source) {
          return new ProjectColumnModel(source);
        }

        @Override
        public ProjectColumnModel[] newArray(final int size) {
