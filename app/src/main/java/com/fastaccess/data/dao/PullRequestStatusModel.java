...
public class PullRequestStatusModel implements Parcelable {
  ...
  public static final Creator<PullRequestStatusModel> CREATOR =
      new Creator<PullRequestStatusModel>() {
        @Override
        public PullRequestStatusModel createFromParcel(final Parcel source) {
          return new PullRequestStatusModel(source);
        }

        @Override
        public PullRequestStatusModel[] newArray(final int size) {
