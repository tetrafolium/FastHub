...
public class PullsIssuesParser implements Parcelable {
  ...
  public void setRepoId(final String repoId) { this.repoId = repoId; }
  ...
  public static final Parcelable.Creator<PullsIssuesParser> CREATOR =
      new Parcelable.Creator<PullsIssuesParser>() {
        @Override
        public PullsIssuesParser createFromParcel(final Parcel source) {
          return new PullsIssuesParser(source);
        }

        @Override
        public PullsIssuesParser[] newArray(final int size) {
