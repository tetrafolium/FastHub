...
public abstract class AbstractCommit implements Parcelable {
  ...
  public static Disposable save(@NonNull List<Commit> models,
  ...
  public static Single<List<Commit>> getCommits(@NonNull String repoId,
  ...
  public static Observable<Commit> getCommit(@NonNull String sha,
