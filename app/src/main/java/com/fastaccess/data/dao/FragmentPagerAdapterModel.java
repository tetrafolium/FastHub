...
public class FragmentPagerAdapterModel {
  ...
  buildForProfile(@NonNull Context context, @NonNull String login) {
    return Stream
  ...
  @NonNull
  public static List<FragmentPagerAdapterModel>
  buildForRepoCode(@NonNull Context context, @NonNull String repoId,
                   @NonNull String login, @NonNull String url,
                   @NonNull String defaultBranch, @NonNull String htmlUrl) {
    return Stream
        .of(new FragmentPagerAdapterModel(
  ...
  @NonNull
  public static List<FragmentPagerAdapterModel>
  buildForSearch(@NonNull Context context) {
    return Stream
  ...
  @NonNull
  public static List<FragmentPagerAdapterModel>
  buildForIssues(@NonNull Context context, long commentId) {
    return Stream
        .of(new FragmentPagerAdapterModel(
  ...
  @NonNull
  public static List<FragmentPagerAdapterModel>
  buildForPullRequest(@NonNull Context context,
  ...
  @NonNull
  public static List<FragmentPagerAdapterModel>
  buildForRepoIssue(@NonNull Context context, @NonNull String login,
  ...
  @NonNull
  public static List<FragmentPagerAdapterModel>
  buildForRepoPullRequest(@NonNull Context context, @NonNull String login,
                          @NonNull String repoId) {
    return Stream
  ...
  @NonNull
  public static List<FragmentPagerAdapterModel>
  buildForCommit(@NonNull Context context, @NonNull Commit commitModel) {
  ...
  @NonNull
  public static List<FragmentPagerAdapterModel>
  buildForGist(@NonNull Context context, @NonNull Gist gistsModel) {
    return Stream
        .of(new FragmentPagerAdapterModel(
                context.getString(R.string.files),
  ...
  @NonNull
  public static List<FragmentPagerAdapterModel>
  buildForNotifications(@NonNull Context context) {
    return Stream
  ...
  @NonNull
  public static List<FragmentPagerAdapterModel>
  buildForGists(@NonNull Context context) {
    return Stream
        .of(new FragmentPagerAdapterModel(
  ...
  @NonNull
  public static List<FragmentPagerAdapterModel>
  buildForMyIssues(@NonNull Context context) {
    return Stream
        .of(new FragmentPagerAdapterModel(
  ...
  @NonNull
  public static List<FragmentPagerAdapterModel>
  buildForMyPulls(@NonNull Context context) {
    return Stream
        .of(new FragmentPagerAdapterModel(
                context.getString(R.string.created),
  ...
  @NonNull
  public static List<FragmentPagerAdapterModel>
  buildForOrg(@NonNull Context context, @NonNull String login,
              boolean isMember) {
    return Stream
        .of(new FragmentPagerAdapterModel(
  ...
  @NonNull
  public static List<FragmentPagerAdapterModel>
  buildForTeam(@NonNull Context context, long id) {
    return Stream
  ...
  @NonNull
  public static List<FragmentPagerAdapterModel>
  buildForBranches(@NonNull Context context, @NonNull String repoId,
  ...
  @NonNull
  public static List<FragmentPagerAdapterModel>
  buildForRepoProjects(@NonNull Context context, @Nullable String repoId,
                       @NonNull String login) {
    return Stream
        .of(new FragmentPagerAdapterModel(
  ...
  @NonNull
  public static List<FragmentPagerAdapterModel>
  buildForProjectColumns(@NonNull List<ProjectColumnModel> models,
  ...
  @NonNull
  public static List<FragmentPagerAdapterModel>
  buildForPinned(@NonNull Context context) {
    return Stream
        .of(new FragmentPagerAdapterModel(context.getString(R.string.repos),
  ...
  @NonNull
  public static List<FragmentPagerAdapterModel>
  buildForDrawer(@NonNull Context context) {
    return Stream
        .of(new FragmentPagerAdapterModel(
