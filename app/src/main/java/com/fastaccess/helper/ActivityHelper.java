...
public class ActivityHelper {
  ...
  private static void openChooser(@NonNull Context context, @NonNull Uri url,
  ...
  public static void openChooser(@NonNull Context context,
                                 @NonNull String url) {
    openChooser(context, Uri.parse(url));
  }

  @SafeVarargs
  public static void start(@NonNull Activity activity, Class cl,
  ...
  public static void start(@NonNull Activity activity, Intent intent,
  ...
  public static void startReveal(@NonNull Activity activity, Intent intent,
                                 @NonNull View sharedElement, int requestCode) {
  ...
  public static void startReveal(@NonNull Fragment fragment, Intent intent,
                                 @NonNull View sharedElement, int requestCode) {
    if (!PrefGetter.isAppAnimationDisabled()) {
      ActivityOptionsCompat options =
          ActivityOptionsCompat.makeClipRevealAnimation(
  ...
  private static boolean isExplanationNeeded(@NonNull Activity context,
  ...
  isReadWritePermissionIsGranted(@NonNull Context context) {
  ...
  checkAndRequestReadWritePermission(@NonNull Activity activity) {
  ...
  private static Intent chooserIntent(@NonNull Context context,
  ...
  public static void activateLinkInterceptorActivity(Context context,
                                                     boolean activate) {
    final PackageManager pm = context.getPackageManager();
  ...
  public static Intent editBundle(@NonNull Intent intent,
