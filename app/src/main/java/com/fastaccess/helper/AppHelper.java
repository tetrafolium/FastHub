...
public class AppHelper {
  ...
  getFragmentByTag(final @NonNull FragmentManager fragmentManager,
  ...
  public static void copyToClipboard(final @NonNull Context context,
    ...
    ClipData clip =
        ClipData.newPlainText(context.getString(R.string.app_name), uri);
    if (clipboard != null) {
  ...
  public static String getFastHubIssueTemplate(final boolean enterprise) {
    ...
    String model = (!isEmulator())
                       ? DeviceNameGetter.getInstance().getDeviceName()
                       : "Android Emulator";
    StringBuilder builder =
        new StringBuilder()
            ...
            .append("  \n")
            .append(!isInstalledFromPlaySore(App.getInstance())
                        ? "**APK Source: Unknown**  \n"
                        : "")
            ...
            .append("  \n")
            .append("- **")
            .append(!model.equalsIgnoreCase(brand) ? "Manufacturer"
                                                   : "Manufacturer&Brand")
            .append(":** ")
  ...
  private static void updateResources(final Context context,
  ...
  private static void updateResourcesLegacy(final Context context,
                                            final String language) {
    Locale locale = getLocale(language);
    Locale.setDefault(locale);
  ...
  private static boolean isInstalledFromPlaySore(final
                                                 @NonNull Context context) {
    final String ipn = context.getPackageManager().getInstallerPackageName(
  ...
  public static boolean isDeviceAnimationEnabled(final
                                                 @NonNull Context context) {
    float duration =
        Settings.Global.getFloat(context.getContentResolver(),
