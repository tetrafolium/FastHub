...
public class Logger {
  ...
  private static void e(final @NonNull String tag,
                        final @Nullable Object text) {
    if (!DEBUG)
      return;
    Log.e(tag, text != null ? text.toString() : "LOGGER IS NULL"); // avoid null
  }

  private static void d(final @NonNull String tag,
                        final @Nullable Object text) {
    if (!DEBUG)
      return;
  ...
  private static void i(final @NonNull String tag,
                        final @Nullable Object text) {
    if (!DEBUG)
      return;
  ...
  public static void d(final @Nullable Object text) {
    d(getCurrentClassName() + " || " + getCurrentMethodName(),
      text); // avoid null
  }

  public static void i(final @Nullable Object text) {
    i(getCurrentClassName() + " || " + getCurrentMethodName(),
      text); // avoid null
  }

  public static void e(final Object... objects) {
    if (objects != null && objects.length > 0) {
      e(getCurrentClassName() + " || " + getCurrentMethodName(),
