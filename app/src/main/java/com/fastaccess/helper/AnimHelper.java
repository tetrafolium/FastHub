...
public class AnimHelper {
  ...
  private static void animateVisibility(@Nullable final View view,
                                        final boolean show, int visibility) {
    if (view == null) {
      return;
    }
  ...
  @UiThread
  public static void revealPopupWindow(@NonNull PopupWindow popupWindow,
                                       @NonNull View from) {
  ...
  @UiThread
  public static void dismissDialog(@NonNull DialogFragment dialogFragment,
                                   int duration,
  ...
  public static void mimicFabVisibility(
      boolean show, @NonNull View view,
