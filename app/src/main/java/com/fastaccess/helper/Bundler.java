...
public class Bundler {
  ...
  public Bundler putIntegerArrayList(@NonNull String key,
  ...
  public Bundler putStringArrayList(@NonNull String key,
  ...
  public Bundler putCharSequenceArrayList(@NonNull String key,
  ...
  public Bundler putParcelableArrayList(@NonNull String key,
  ...
  public Bundler
  putSparseParcelableArray(@NonNull String key,
