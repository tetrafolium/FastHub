...
public class PrefGetter {
  ...
  private static final String FAB_LONG_PRESS_REPO_GUIDE =
      "fab_long_press_repo_guide";
  ...
  private static final String MIDNIGHTBLUE_THEME_ENABLED =
  ...
  private static final String NOTIFICATION_SOUND_PATH =
      "notification_sound_path";
  private static final String DISABLE_AUTO_LOAD_IMAGE =
      "disable_auto_loading_image";
  private static final String PLAY_STORE_REVIEW_ACTIVITY =
  ...
  public static String getToken() { return PrefHelper.getString(TOKEN); }
  ...
  public static String getOtpCode() { return PrefHelper.getString(OTP_CODE); }

  public static void setOtpCode(final @Nullable String otp) {
    PrefHelper.set(OTP_CODE, otp);
  }

  public static boolean isAdsEnabled() { return PrefHelper.getBoolean(ADS); }

  public static void setAdsEnabled(final boolean isEnabled) {
    PrefHelper.set(ADS, isEnabled);
  }

  public static void clear() { PrefHelper.clearPrefs(); }
  ...
  public static int getNotificationTaskDuration() {
    if (PrefHelper.isExist("notificationEnabled") &&
  ...
  public static int notificationDurationMillis(final
                                               @NonNull String prefValue) {
  ...
  @ThemeType
  public static int getThemeType(final @NonNull Context context) {
  ...
  @ThemeColor
  public static int getThemeColor(final @NonNull Context context) {
    return getThemeColor(context.getResources());
  }

  @ThemeType
  static int getThemeType(final @NonNull Resources resources) {
    String appTheme = PrefHelper.getString("appTheme");
    if (!InputHelper.isEmpty(appTheme)) {
      if (appTheme.equalsIgnoreCase(
              resources.getString(R.string.dark_theme_mode))) {
        return DARK;
      } else if (appTheme.equalsIgnoreCase(
  ...
  @ThemeColor
  private static int getThemeColor(final @NonNull Resources resources) {
    String appColor = PrefHelper.getString("appColor");
    return getThemeColor(resources, appColor);
  }

  // used for color picker to get the index of the color (enum) from the name of
  // the color
  public static int getThemeColor(final @NonNull Resources resources,
                                  final String appColor) {
    if (!InputHelper.isEmpty(appColor)) {
      if (appColor.equalsIgnoreCase(
  ...
  public static Uri getNotificationSound() {
    ...
    return !InputHelper.isEmpty(nsp)
        ? Uri.parse(nsp)
  ...
  public static boolean isAutoImageDisabled() {
    return PrefHelper.getBoolean(DISABLE_AUTO_LOAD_IMAGE) &&
        AppHelper.isDataPlan();
  }
  ...
  public static boolean isIssuesLongPressHintShowed() {
    boolean isIssuesLongPressHintShowed =
        PrefHelper.getBoolean("issues_long_press_hint");
  ...
  public static boolean isPRLongPressHintShowed() {
    boolean isPRLongPressHintShowed =
        PrefHelper.getBoolean("pr_long_press_hint");
