...
public class RepoFilesAdapter
    extends BaseRecyclerAdapter<RepoFile, RepoFilesViewHolder,
  ...
  @Override
  protected RepoFilesViewHolder viewHolder(ViewGroup parent, int viewType) {
    return RepoFilesViewHolder.newInstance(parent, this);
  }

  @Override
  protected void onBindView(RepoFilesViewHolder holder, int position) {
