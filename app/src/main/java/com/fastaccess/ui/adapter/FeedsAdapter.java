...
public class FeedsAdapter
    extends BaseRecyclerAdapter<Event, FeedsViewHolder,
                                BaseViewHolder.OnItemClickListener<Event>> {

  private boolean noImage;

  public FeedsAdapter(@NonNull ArrayList<Event> events) { this(events, false); }
  ...
  @Override
  protected FeedsViewHolder viewHolder(ViewGroup parent, int viewType) {
    return new FeedsViewHolder(FeedsViewHolder.getView(parent, noImage), this);
  }

  @Override
  protected void onBindView(FeedsViewHolder holder, int position) {
