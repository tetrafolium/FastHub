...
public class NotificationsAdapter extends BaseRecyclerAdapter<
  ...
  public NotificationsAdapter(
      final @NonNull ArrayList<GroupedNotificationModel> eventsModels,
      final boolean showUnreadState, final boolean hideClear) {
    super(eventsModels);
    this.showUnreadState = showUnreadState;
