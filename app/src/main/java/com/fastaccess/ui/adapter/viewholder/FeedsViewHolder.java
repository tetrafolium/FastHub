...
public class FeedsViewHolder extends BaseViewHolder<Event> {
  ...
  private void appendOrganizationEvent(SpannableBuilder spannableBuilder,
                                       Event eventsModel) {
    spannableBuilder
  ...
  private void appendProjectCardEvent(SpannableBuilder spannableBuilder,
                                      Event eventsModel, boolean isColumn) {
  ...
  private void appendOrgBlockEvent(SpannableBuilder spannableBuilder,
                                   Event eventsModel) {
    spannableBuilder.bold(eventsModel.getPayload().getAction())
        .append(" ")
  ...
  private void appendForkApplyEvent(SpannableBuilder spannableBuilder,
                                    Event eventsModel) {
  ...
  private void appendReleaseEvent(SpannableBuilder spannableBuilder,
                                  Event eventsModel) {
  ...
  private void appendDeleteEvent(SpannableBuilder spannableBuilder,
                                 Event eventsModel) {
  ...
  private void appendTeamEvent(SpannableBuilder spannableBuilder,
                               Event eventsModel) {
  ...
  private void appendPushEvent(SpannableBuilder spannableBuilder,
                               Event eventsModel) {
  ...
  private void
  appendPullRequestReviewCommentEvent(SpannableBuilder spannableBuilder,
                                      Event eventsModel) {
  ...
  private void appendPullRequestEvent(SpannableBuilder spannableBuilder,
                                      Event eventsModel) {
  ...
  private void appendPublicEvent(SpannableBuilder spannableBuilder,
                                 Event eventsModel) {
  ...
  private void appendMemberEvent(SpannableBuilder spannableBuilder,
                                 Event eventsModel) {
  ...
  private void appendIssueEvent(SpannableBuilder spannableBuilder,
                                Event eventsModel) {
  ...
  private void appendIssueCommentEvent(SpannableBuilder spannableBuilder,
                                       Event eventsModel) {
    Comment comment = eventsModel.getPayload().getComment();
    Issue issue = eventsModel.getPayload().getIssue();
  ...
  private void appendGollumEvent(SpannableBuilder spannableBuilder,
                                 Event eventsModel) {
  ...
  private void appendGistEvent(SpannableBuilder spannableBuilder,
                               Event eventsModel) {
    String action = eventsModel.getPayload().getAction();
  ...
  private void appendForkEvent(SpannableBuilder spannableBuilder,
                               Event eventsModel) {
    spannableBuilder.bold("forked").append(" ").append(
        eventsModel.getRepo().getName());
  }

  private void appendFollowEvent(SpannableBuilder spannableBuilder,
                                 Event eventsModel) {
  ...
  private void appendDownloadEvent(SpannableBuilder spannableBuilder,
                                   Event eventsModel) {
  ...
  private void appendCreateEvent(SpannableBuilder spannableBuilder,
                                 Event eventsModel) {
  ...
  private void appendWatch(SpannableBuilder spannableBuilder, EventsType type,
                           Event eventsModel) {
  ...
  private void appendCommitComment(SpannableBuilder spannableBuilder,
                                   Event eventsModel) {
  ...
  private void appendActor(@NonNull Event eventsModel,
