...
public class LabelsViewHolder extends BaseViewHolder<LabelModel> {
  ...
  private LabelsViewHolder(@NonNull View itemView,
                           LabelsAdapter.OnSelectLabel onSelectLabel,
  ...
  newInstance(@NonNull ViewGroup parent,
              @Nullable LabelsAdapter.OnSelectLabel onSelectLabel,
              @NonNull BaseRecyclerAdapter adapter) {
  ...
  @Override
  public void bind(@NonNull LabelModel labelModel) {
