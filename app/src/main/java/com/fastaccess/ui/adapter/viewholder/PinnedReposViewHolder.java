...
public class PinnedReposViewHolder extends BaseViewHolder<PinnedRepos> {
  ...
  private PinnedReposViewHolder(final @NonNull View itemView,
                                final @Nullable BaseRecyclerAdapter adapter) {
    super(itemView, adapter);
  }

  public static PinnedReposViewHolder
  newInstance(final ViewGroup viewGroup, final BaseRecyclerAdapter adapter,
              final boolean singleLine) {
    return new PinnedReposViewHolder(
        getView(viewGroup, singleLine ? R.layout.repos_row_item_menu
                                      : R.layout.repos_row_item),
        adapter);
  }

  @Override
  public void bind(final @NonNull PinnedRepos pinnedRepos) {
