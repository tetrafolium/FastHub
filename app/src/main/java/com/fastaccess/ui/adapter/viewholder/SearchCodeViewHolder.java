...
public class SearchCodeViewHolder extends BaseViewHolder<SearchCodeModel> {
  ...
  private SearchCodeViewHolder(@NonNull View itemView,
                               @Nullable BaseRecyclerAdapter adapter) {
    super(itemView, adapter);
  }

  public static SearchCodeViewHolder newInstance(ViewGroup viewGroup,
  ...
  @Override
  public void bind(@NonNull SearchCodeModel searchCodeModel) {}
}
