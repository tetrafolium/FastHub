...
public class GroupedReviewsViewHolder extends BaseViewHolder<TimelineModel>
  ...
  private GroupedReviewsViewHolder(
      final @NonNull View itemView, final ViewGroup viewGroup,
      ...
      final @NonNull PullRequestTimelineMvp
  ...
  @Override
  public void bind(final @NonNull TimelineModel model) {
