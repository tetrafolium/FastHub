...
public class PullRequestViewHolder extends BaseViewHolder<PullRequest> {
  ...
  private PullRequestViewHolder(@NonNull View itemView,
  ...
  public static PullRequestViewHolder newInstance(ViewGroup viewGroup,
                                                  BaseRecyclerAdapter adapter,
                                                  boolean withAvatar,
                                                  boolean showRepoName) {
    if (withAvatar) {
      return new PullRequestViewHolder(
          getView(viewGroup, R.layout.issue_row_item), adapter, true,
          showRepoName);
    }
    return new PullRequestViewHolder(
  ...
  @Override
  public void bind(@NonNull PullRequest pullRequest) {
    ...
    if (withAvatar && avatarLayout != null) {
      avatarLayout.setUrl(
          pullRequest.getUser().getAvatarUrl(),
          pullRequest.getUser().getLogin(), false,
          LinkParserHelper.isEnterprise(pullRequest.getHtmlUrl()));
