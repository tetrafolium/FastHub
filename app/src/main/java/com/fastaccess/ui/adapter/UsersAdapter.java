...
public class UsersAdapter
  ...
  public UsersAdapter(@NonNull ArrayList<User> list) { this(list, false); }
  ...
  @Override
  protected UsersViewHolder viewHolder(ViewGroup parent, int viewType) {
    return UsersViewHolder.newInstance(parent, this, isFilter);
  }

  @Override
  protected void onBindView(UsersViewHolder holder, int position) {
