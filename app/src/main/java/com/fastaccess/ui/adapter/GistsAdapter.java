...
public class GistsAdapter
  ...
  public GistsAdapter(@NonNull ArrayList<Gist> gistsModels,
  ...
  @Override
  protected GistsViewHolder viewHolder(ViewGroup parent, int viewType) {
    return GistsViewHolder.newInstance(parent, this, isForProfile);
  }

  @Override
  protected void onBindView(GistsViewHolder holder, int position) {
