...
public class GistsAdapter
    extends BaseRecyclerAdapter<Gist, GistsViewHolder,
  ...
  public GistsAdapter(final @NonNull ArrayList<Gist> gistsModels,
                      final boolean isForProfile) {
    super(gistsModels);
    this.isForProfile = isForProfile;
  }

  @Override
  protected GistsViewHolder viewHolder(final ViewGroup parent,
                                       final int viewType) {
    return GistsViewHolder.newInstance(parent, this, isForProfile);
  }

  @Override
  protected void onBindView(final GistsViewHolder holder, final int position) {
