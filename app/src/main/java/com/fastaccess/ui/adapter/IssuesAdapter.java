...
public class IssuesAdapter
    extends BaseRecyclerAdapter<Issue, IssuesViewHolder,
  ...
  public IssuesAdapter(final @NonNull List<Issue> data) { this(data, false); }
  ...
  @Override
  protected IssuesViewHolder viewHolder(final ViewGroup parent,
                                        final int viewType) {
  ...
  @Override
  protected void onBindView(final IssuesViewHolder holder, final int position) {
