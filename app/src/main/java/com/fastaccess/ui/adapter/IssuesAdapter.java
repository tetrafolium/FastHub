...
public class IssuesAdapter
  ...
  public IssuesAdapter(@NonNull List<Issue> data) { this(data, false); }
  ...
  @Override
  protected IssuesViewHolder viewHolder(ViewGroup parent, int viewType) {
    return IssuesViewHolder.newInstance(parent, this, withAvatar, showRepoName,
                                        showState);
  }

  @Override
  protected void onBindView(IssuesViewHolder holder, int position) {
