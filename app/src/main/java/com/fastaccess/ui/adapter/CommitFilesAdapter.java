...
public class CommitFilesAdapter extends BaseRecyclerAdapter<
  ...
  public CommitFilesAdapter(
      @NonNull ArrayList<CommitFileChanges> eventsModels,
  ...
  @Override
  protected PullRequestFilesViewHolder viewHolder(ViewGroup parent,
                                                  int viewType) {
  ...
  @Override
  protected void onBindView(PullRequestFilesViewHolder holder, int position) {
