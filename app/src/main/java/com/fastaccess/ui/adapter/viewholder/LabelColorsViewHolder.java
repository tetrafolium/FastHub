...
public class LabelColorsViewHolder extends BaseViewHolder<String> {
  ...
  private LabelColorsViewHolder(@NonNull View itemView,
                                @Nullable BaseRecyclerAdapter adapter) {
    super(itemView, adapter);
  }

  public static LabelColorsViewHolder newInstance(ViewGroup parent,
  ...
  @Override
  public void bind(@NonNull String labelModel) {
