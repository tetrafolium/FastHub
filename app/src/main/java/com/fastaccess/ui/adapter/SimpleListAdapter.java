...
public class SimpleListAdapter<O>
  ...
  public SimpleListAdapter(
      @NonNull List<O> data,
      @Nullable SimpleViewHolder.OnItemClickListener<O> listener) {
    super(data, listener);
  }

  @Override
  protected SimpleViewHolder<O> viewHolder(ViewGroup parent, int viewType) {
    return new SimpleViewHolder<>(
        BaseViewHolder.getView(parent, R.layout.simple_row_item), this);
  }

  @Override
  protected void onBindView(SimpleViewHolder<O> holder, int position) {
