...
public class CommentsAdapter
    extends BaseRecyclerAdapter<Comment, CommentsViewHolder,
  ...
  @Override
  protected CommentsViewHolder viewHolder(final ViewGroup parent,
                                          final int viewType) {
    return CommentsViewHolder.newInstance(parent, this);
  }

  @Override
  protected void onBindView(final CommentsViewHolder holder,
                            final int position) {
