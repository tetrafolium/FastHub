...
public class OrgTeamFragment
    extends BaseFragment<OrgTeamMvp.View, OrgTeamPresenter>
    implements OrgTeamMvp.View {
  ...
  @Override
  public void onNotifyAdapter(@Nullable List<TeamsModel> items, int page) {
    hideProgress();
  ...
  @NonNull
  @Override
  public OrgTeamPresenter providePresenter() {
