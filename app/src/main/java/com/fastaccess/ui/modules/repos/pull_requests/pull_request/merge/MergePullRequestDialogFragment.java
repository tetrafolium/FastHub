...
public class MergePullRequestDialogFragment
    extends BaseDialogFragment<MergePullReqeustMvp.View,
                               MergePullRequestPresenter>
  ...
  public static MergePullRequestDialogFragment
  newInstance(@Nullable String title) {
    MergePullRequestDialogFragment view = new MergePullRequestDialogFragment();
    view.setArguments(Bundler.start().put(BundleConstant.EXTRA, title).end());
    return view;
  }
  ...
  public void onClick(View view) {
    if (view.getId() == R.id.ok) {
      ...
      mergeCallback.onMerge(
          ...
          mergeMethod.getSelectedItem().toString().toLowerCase());
    }
    dismiss();
  }
