...
class RepoFilesPresenter
  ...
  @Override
  public void onItemLongClick(int position, View v, RepoFile item) {
  ...
  @Override
  public void onCallApi(@Nullable RepoFile toAppend) {
  ...
  @Override
  public void onInitDataAndRequest(@NonNull String login,
                                   @NonNull String repoId, @NonNull String path,
  ...
  @Nullable
  @Override
  public List<RepoFile> getCachedFiles(@NonNull String url,
                                       @NonNull String ref) {
    return pathsModel.getPaths(url, ref);
  }

  @Override
  public void onDeleteFile(@NonNull String message, @NonNull RepoFile item,
