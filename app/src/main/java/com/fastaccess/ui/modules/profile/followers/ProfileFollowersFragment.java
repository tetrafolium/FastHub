...
public class ProfileFollowersFragment
    extends BaseFragment<ProfileFollowersMvp.View, ProfileFollowersPresenter>
    implements ProfileFollowersMvp.View {
  ...
  public static ProfileFollowersFragment newInstance(final
  ...
  protected void onFragmentCreated(final @NonNull View view,
    ...
    if (getPresenter().getFollowers().isEmpty() &&
  ...
  @NonNull
  @Override
  public ProfileFollowersPresenter providePresenter() {
