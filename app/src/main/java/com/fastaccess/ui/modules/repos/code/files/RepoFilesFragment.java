...
public class RepoFilesFragment
  ...
  @Override
  public void onItemClicked(final @NonNull RepoFile model) {
  ...
  @Override
  public void onMenuClicked(final int position, final @NonNull RepoFile item,
                            final View v) {
    if (login == null) {
      login = Login.getUser();
    }
  ...
  @Override
  public void
  onSetData(final @NonNull String login, final @NonNull String repoId,
            final @NonNull String path, final @NonNull String ref,
            final boolean clear, final @Nullable RepoFile toAppend) {
  ...
  @Override
  public void onUpdateTab(final @Nullable RepoFile toAppend) {
  ...
  @Override
  public void onDelete(final @NonNull String message, final int position) {
