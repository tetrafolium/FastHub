...
public class AllNotificationsFragment
    extends BaseFragment<AllNotificationsMvp.View, AllNotificationsPresenter>
  ...
  @Override
  public void onUpdateReadState(GroupedNotificationModel item, int position) {
  ...
  @Override
  public void onNotifyAdapter(@Nullable List<GroupedNotificationModel> items) {
    hideProgress();
  ...
  @Override
  public void onReadNotification(@NonNull Notification notification) {
    GroupedNotificationModel model = new GroupedNotificationModel(notification);
    if (onNotificationChangedListener != null)
      onNotificationChangedListener.onNotificationChanged(model, 0);
    adapter.swapItem(model);
    ReadNotificationService.start(getContext(), notification.getId());
  }

  @Override
  public void onMarkAllByRepo(@NonNull Repo repo) {
  ...
  protected void onFragmentCreated(@NonNull View view,
    ...
    adapter =
        new NotificationsAdapter(getPresenter().getNotifications(), true, true);
