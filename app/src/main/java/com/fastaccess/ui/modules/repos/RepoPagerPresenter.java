...
class RepoPagerPresenter
  ...
  @Override
  public void onUpdatePinnedEntry(@NonNull String repoId,
                                  @NonNull String login) {
    manageDisposable(PinnedRepos.updateEntry(login + "/" + repoId));
  }

  @Override
  public void onActivityCreate(@NonNull String repoId, @NonNull String login,
                               int navTyp) {
    this.login = login;
    this.repoId = repoId;
    this.navTyp = navTyp;
  ...
  @Override
  public void onModuleChanged(@NonNull FragmentManager fragmentManager,
                              @RepoPagerMvp.RepoNavigationType int type) {
  ...
  @Override
  public void onShowHideFragment(@NonNull FragmentManager fragmentManager,
                                 @NonNull Fragment toShow,
  ...
  @Override
  public void onAddAndHide(@NonNull FragmentManager fragmentManager,
  ...
  @Override
  public void updatePinned(int forks, int stars, int watching) {
  ...
  @Override
  public void onMenuItemSelect(@IdRes int id, int position, boolean fromUser) {
  ...
  @Override
  public void onMenuItemReselect(@IdRes int id, int position,
                                 boolean fromUser) {}
