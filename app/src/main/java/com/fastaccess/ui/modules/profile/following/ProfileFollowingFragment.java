...
public class ProfileFollowingFragment
    extends BaseFragment<ProfileFollowingMvp.View, ProfileFollowingPresenter>
    implements ProfileFollowingMvp.View {
  ...
  public static ProfileFollowingFragment newInstance(final
  ...
  protected void onFragmentCreated(final @NonNull View view,
    ...
    if (getPresenter().getFollowing().isEmpty() &&
