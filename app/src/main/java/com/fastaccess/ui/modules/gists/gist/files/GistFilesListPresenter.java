...
public class GistFilesListPresenter extends BasePresenter<GistFilesListMvp.View>
    implements GistFilesListMvp.Presenter {
  private ArrayList<FilesListModel> listModels;
  @Getter private HashMap<String, FilesListModel> filesMap = new HashMap<>();

  @Override
  public void onItemClick(int position, View v, FilesListModel item) {
    if (getView() != null) {
  ...
  @Override
  public void onItemLongClick(int position, View v, FilesListModel item) {}

  @Override
  public void onSetList(@Nullable ArrayList<FilesListModel> files) {
