...
public class ProfileOverviewFragment
    extends BaseFragment<ProfileOverviewMvp.View, ProfileOverviewPresenter>
    implements ProfileOverviewMvp.View {
  ...
  public static ProfileOverviewFragment newInstance(final
  ...
  @Override
  public void onInitViews(final @Nullable User userModel) {
    progress.setVisibility(GONE);
    if (userModel == null)
      return;
    if (profileCallback != null)
      profileCallback.onCheckType(userModel.isOrganizationType());
    if (getView() != null) {
      if (this.userModel == null) {
        TransitionManager.beginDelayedTransition(
            (ViewGroup)getView(),
            new AutoTransition().addListener(
                new Transition.TransitionListener() {
                  @Override
                  public void onTransitionStart(
                      final @NonNull Transition transition) {}

                  @Override
                  public void onTransitionEnd(final
  ...
  public void invalidateFollowBtn() {
    ...
    if (getPresenter().isSuccessResponse()) {
      ...
      followBtn.setText(getPresenter().isFollowing()
  ...
  @Override
  public void onInitContributions(final boolean show) {
    if (contributionView == null)
      return;
    if (show) {
  ...
  @Override
  public void onInitOrgs(final @Nullable List<User> orgs) {
    if (orgs != null && !orgs.isEmpty()) {
      ...
      ((GridManager)orgsList.getLayoutManager())
          .setIconSize(
              getResources().getDimensionPixelSize(R.dimen.header_icon_zie) +
  ...
  @Override
  public void onInitPinnedRepos(final
                                @NonNull List<GetPinnedReposQuery.Node> nodes) {
    if (pinnedReposTextView == null)
      return;
    if (!nodes.isEmpty()) {
      ...
      adapter.setListener(
          new BaseViewHolder.OnItemClickListener<GetPinnedReposQuery.Node>() {
            @Override
            public void onItemClick(final int position, final View v,
                                    final GetPinnedReposQuery.Node item) {
  ...
  private void onHideProgress() { hideProgress(); }

  private boolean isMeOrOrganization() {
    return Login.getUser() != null &&
        Login.getUser().getLogin().equalsIgnoreCase(
            getPresenter().getLogin()) ||
        (userModel != null && userModel.getType() != null &&
