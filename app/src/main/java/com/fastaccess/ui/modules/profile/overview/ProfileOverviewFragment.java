...
public class ProfileOverviewFragment
  ...
  @Override
  public void onInitViews(@Nullable User userModel) {
  ...
  @Override
  public void onInitOrgs(@Nullable List<User> orgs) {
  ...
  @Override
  public void onInitPinnedRepos(@NonNull List<GetPinnedReposQuery.Node> nodes) {
