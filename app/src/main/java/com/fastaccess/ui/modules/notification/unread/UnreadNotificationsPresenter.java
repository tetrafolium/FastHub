...
public class UnreadNotificationsPresenter
    extends BasePresenter<UnreadNotificationMvp.View>
    implements UnreadNotificationMvp.Presenter {
    ...
    if (notifications.isEmpty()) {
      manageDisposable(
          RxHelper
              ...
              .flatMap(
                  notifications
                  -> Observable.just(GroupedNotificationModel.onlyNotifications(
                      notifications)))
              .subscribe(
    ...
    Observable<List<GroupedNotificationModel>> observable =
        RestProvider.getNotificationService(PrefGetter.isEnterprise())
            ...
            .flatMap(response -> {
              ...
              return Observable.just(GroupedNotificationModel.onlyNotifications(
                  response.getItems()));
            });
    makeRestCall(
        observable,
