...
public class RepoPagerActivity
  ...
  public static void startRepoPager(@NonNull Context context,
                                    @NonNull NameParser nameParser) {
  ...
  createIntent(@NonNull Context context, @NonNull String repoId,
               @NonNull String login,
  ...
  @Override
  public void
  onNavigationChanged(@RepoPagerMvp.RepoNavigationType int navType) {
