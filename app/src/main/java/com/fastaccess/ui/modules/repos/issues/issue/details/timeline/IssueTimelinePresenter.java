...
public class IssueTimelinePresenter extends BasePresenter<IssueTimelineMvp.View>
  ...
  @Override
  public void
  onHandleReaction(int viewId, long id,
  ...
  @Override
  public boolean onCallApi(int page, @Nullable Issue parameter) {
    if (parameter == null) {
  ...
  private void loadComment(int page, long commentId, String login,
                           String repoId, List<TimelineModel> timeline) {
