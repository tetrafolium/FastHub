...
class OrgReposPresenter
    extends BasePresenter<OrgReposMvp.View> implements OrgReposMvp.Presenter {
  ...
  public boolean onCallApi(final int page, final @Nullable String parameter) {
    ...
    makeRestCall(
        RestProvider.getOrgService(isEnterprise())
            .getOrgRepos(parameter, filterOptions.getQueryMap(), page),
        repoModelPageable -> {
  ...
  @Override
  public void onFilterApply(final String org) {
    onCallApi(1, org);
  }
