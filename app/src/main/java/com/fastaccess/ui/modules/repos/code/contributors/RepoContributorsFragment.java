...
public class RepoContributorsFragment
    extends BaseFragment<RepoContributorsMvp.View, RepoContributorsPresenter>
    implements RepoContributorsMvp.View {
  ...
  public static RepoContributorsFragment newInstance(@NonNull String repoId,
  ...
  @NonNull
  @Override
  public RepoContributorsPresenter providePresenter() {
