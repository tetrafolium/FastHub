...
public class FilterIssuesActivity
  ...
  public static void startActivity(@NonNull Activity context,
                                   @NonNull String login,
                                   @NonNull String repoId, boolean isIssue,
                                   boolean isOpen, boolean isEnterprise) {
    Intent intent = new Intent(context, FilterIssuesActivity.class);
    intent.putExtras(Bundler.start()
                         .put(BundleConstant.EXTRA, login)
                         .put(BundleConstant.ID, repoId)
  ...
  public static void startActivity(@NonNull View view, @NonNull String login,
                                   @NonNull String repoId, boolean isIssue,
                                   boolean isOpen, boolean isEnterprise,
                                   @NonNull String criteria) {
  ...
  public void onSortClicked() {
    ...
    viewHolder.recycler.setAdapter(new SimpleListAdapter<>(
        lists, new BaseViewHolder.OnItemClickListener<String>() {
          @Override
          public void onItemClick(int position, View v, String item) {
            appendSort(item);
          }

          @Override
          public void onItemLongClick(int position, View v, String item) {}
        }));
  ...
  @Override
  public void onSetCount(int count, boolean isOpen) {
    if (isOpen) {
