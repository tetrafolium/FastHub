...
class PullRequestPagerPresenter extends BasePresenter<PullRequestPagerMvp.View>
  ...
  @Override
  public void onHandleConfirmDialog(@Nullable Bundle bundle) {
    if (bundle != null) {
  ...
  @NonNull
  @Override
  public SpannableBuilder getMergeBy(@NonNull PullRequest pullRequest,
  ...
  @Override
  public void onPutMilestones(@NonNull MilestoneModel milestone) {
  ...
  @Override
  public void onUpdatePullRequest(@NonNull PullRequest pullRequestModel) {
  ...
  @Override
  public void onAddComment(@NonNull CommentRequestModel comment) {
  ...
  private void updateTimeline(PullRequestPagerMvp.View view,
                              int assignee_added) {
