...
public class IssuePopupFragment
  ...
  public static void showPopup(final @NonNull FragmentManager manager,
  ...
  private static Bundle getBundle(
      ...
      final @Nullable LabelListModel labels,
      final @Nullable MilestoneModel milestone, final boolean canComment) {
