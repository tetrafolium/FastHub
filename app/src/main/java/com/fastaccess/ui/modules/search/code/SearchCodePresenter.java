...
class SearchCodePresenter extends BasePresenter<SearchCodeMvp.View>
    implements SearchCodeMvp.Presenter {
  ...
  @Override
  public void onItemClick(int position, View v, SearchCodeModel item) {
    if (getView() != null) {
  ...
  @Override
  public void onItemLongClick(int position, View v, SearchCodeModel item) {}
}
