...
public class FeedsFragment extends BaseFragment<FeedsMvp.View, FeedsPresenter>
  ...
  @Override
  public void onNotifyAdapter(@Nullable List<Event> items, int page) {
    hideProgress();
  ...
  @Override
  public void onOpenRepoChooser(@NonNull ArrayList<SimpleUrlsModel> models) {
  ...
  @Override
  public void onOpenCommitChooser(@NonNull List<GitCommitModel> commits) {
