...
public class FeedsFragment extends BaseFragment<FeedsMvp.View, FeedsPresenter>
    implements FeedsMvp.View {
  ...
  @Override
  public void onNotifyAdapter(final @Nullable List<Event> items,
                              final int page) {
    hideProgress();
  ...
  @Override
  public void onOpenRepoChooser(final
                                @NonNull ArrayList<SimpleUrlsModel> models) {
  ...
  @NonNull
  @Override
  public FeedsPresenter providePresenter() {
  ...
  @Override
  public void onOpenCommitChooser(final @NonNull List<GitCommitModel> commits) {
  ...
  @Override
  public void onItemSelected(final Parcelable item) {
    if (item instanceof SimpleUrlsModel) {
      SchemeParser.launchUri(getContext(),
                             Uri.parse(((SimpleUrlsModel)item).getItem()));
      ...
      Intent intent = CommitPagerActivity.createIntent(
          getContext(), nameParser.getName(), nameParser.getUsername(),
          model.getSha(), true, LinkParserHelper.isEnterprise(model.getUrl()));
