...
public class PinnedGistPresenter extends BasePresenter<PinnedGistMvp.View>
    implements PinnedGistMvp.Presenter {
  private ArrayList<Gist> issues = new ArrayList<>();

  @Override
  protected void onAttachView(@NonNull PinnedGistMvp.View view) {
  ...
  public void onReload() {
    manageDisposable(PinnedGists.getMyPinnedGists().subscribe(
        repos
