...
public class CommitFilesFragment
    extends BaseFragment<CommitFilesMvp.View, CommitFilesPresenter>
    implements CommitFilesMvp.View {
  ...
  public static CommitFilesFragment
  newInstance(@NonNull String sha,
              @Nullable CommitFileListModel commitFileModels) {
  ...
  @Override
  public void onNotifyAdapter(@Nullable List<CommitFileChanges> items) {
    hideProgress();
    if (items != null) {
  ...
  @Override
  public void onCommentAdded(@NonNull Comment newComment) {
    hideProgress();
  ...
  @Override
  public void onOpenForResult(int position, CommitFileChanges model) {
    FullScreenFileChangeActivity.Companion.startActivityForResult(
        this, model, position, true);
  }
  ...
  public void onActivityResult(int requestCode, int resultCode, Intent data) {
    if ((resultCode == Activity.RESULT_OK) && (requestCode ==
      ...
      if ((comments != null && !comments.isEmpty()) && (viewCallback != null &&
            !InputHelper.isEmpty(viewCallback.getLogin()))) {
        getPresenter().onSubmit(viewCallback.getLogin(),
                                viewCallback.getRepoId(), comments.get(0));
      }
    }
  ...
  protected void onFragmentCreated(@NonNull View view,
    ...
    if (getPresenter().changes.isEmpty())
  ...
  @Override
  public void onPatchClicked(int groupPosition, int childPosition, View v,
                             CommitFileModel commit, CommitLinesModel item) {
  ...
  @Override
  public void onCommentAdded(@NonNull String comment,
                             @NonNull CommitLinesModel item, Bundle bundle) {
