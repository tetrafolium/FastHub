...
public class ProfileReposFilterBottomSheetDialog extends BaseBottomSheetDialog {
  ...
  public static ProfileReposFilterBottomSheetDialog
  newInstance(final @NonNull FilterOptionsModel currentFilterOptions) {
    ProfileReposFilterBottomSheetDialog fragment =
        new ProfileReposFilterBottomSheetDialog();
    fragment.setArguments(
        Bundler.start().put(BundleConstant.ITEM, currentFilterOptions).end());
    return fragment;
  }
  ...
  public void onViewCreated(final @NonNull View view,
    ...
    ArrayAdapter<String> sortOptionsAdapter =
        new ArrayAdapter<>(getContext(), android.R.layout.simple_list_item_1,
                           currentFilterOptions.getSortOptionList());
    ArrayAdapter<String> sortDirectionAdapter =
        new ArrayAdapter<>(getContext(), android.R.layout.simple_list_item_1,
    ...
    typeSelectionSpinner.setSelection(
        currentFilterOptions.getSelectedTypeIndex());
    sortSelectionSpinner.setSelection(
        currentFilterOptions.getSelectedSortOptionIndex());
    sortDirectionSpinner.setSelection(
        currentFilterOptions.getSelectedSortDirectionIndex());
  ...
  public void onAttach(final Context context) {
    ...
    if (context instanceof OrgReposMvp.View || getParentFragment() instanceof
                                                   OrgReposMvp.View) {
  ...
  public void onApply() {
    if (listener != null) {
      ...
      listener.onSortOptionSelected(
          (String)sortSelectionSpinner.getSelectedItem());
      listener.onSortDirectionSelected(
          (String)sortDirectionSpinner.getSelectedItem());
  ...
  public void startSearch() {
    if (listener != null) {
      Intent intent = SearchUserActivity.Companion.getIntent(
          getContext(), listener.getLogin(), "");
