...
public class MyPullRequestFragment
  ...
  newInstance(final @NonNull IssueState issueState,
              final @NonNull MyIssuesType issuesType) {
  ...
  @Override
  public void onNotifyAdapter(final @Nullable List<PullRequest> items,
                              final int page) {
    hideProgress();
  ...
  @Override
  public void onSetCount(final int totalCount) {
  ...
  @Override
  public void onFilterIssue(final @NonNull IssueState issueState) {
  ...
  @Override
  public void onShowPopupDetails(final @NonNull PullRequest item) {
