...
public class MyPullRequestFragment
    extends BaseFragment<MyPullRequestsMvp.View, MyPullRequestsPresenter>
    implements MyPullRequestsMvp.View {
  ...
  public static MyPullRequestFragment
  newInstance(@NonNull IssueState issueState,
              @NonNull MyIssuesType issuesType) {
  ...
  @Override
  public void onSetCount(int totalCount) {
  ...
  protected void onFragmentCreated(@NonNull View view,
    ...
    if (savedInstanceState == null) {
      issueState =
          (IssueState)getArguments().getSerializable(BundleConstant.EXTRA);
    }
    ...
    adapter =
        new PullRequestAdapter(getPresenter().getPullRequests(), false, true);
    ...
    if (savedInstanceState == null ||
        (getPresenter().getPullRequests().isEmpty() &&
  ...
  @NonNull
  @Override
  public MyPullRequestsPresenter providePresenter() {
    return new MyPullRequestsPresenter();
  }

  @Override
  public void onFilterIssue(@NonNull IssueState issueState) {
  ...
  @Override
  public void onShowPopupDetails(@NonNull PullRequest item) {
  ...
  private MyIssuesType getIssuesType() {
    return (MyIssuesType)getArguments().getSerializable(
