...
class ProfileOverviewPresenter extends BasePresenter<ProfileOverviewMvp.View>
  ...
  @Override
  public void onCheckFollowStatus(@NonNull String login) {
  ...
  @Override
  public void onFollowButtonClicked(@NonNull String login) {
    manageDisposable(
        RxHelper
  ...
  @Override
  public void onSendUserToView(@Nullable User userModel) {
    sendToView(view -> view.onInitViews(userModel));
  }

  @Override
  public void onLoadContributionWidget(
      @NonNull GitHubContributionsView gitHubContributionsView) {
    if (!isEnterprise()) {
  ...
  private void
  loadContributions(ArrayList<ContributionsDay> contributions,
