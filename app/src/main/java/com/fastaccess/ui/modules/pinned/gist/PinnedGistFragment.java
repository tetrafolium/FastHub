...
public class PinnedGistFragment
    extends BaseFragment<PinnedGistMvp.View, PinnedGistPresenter>
    implements PinnedGistMvp.View {
  ...
  @Override
  public void onNotifyAdapter(@Nullable List<Gist> items) {
  ...
  @Override
  public void onDeletePinnedGist(long id, int position) {
    MessageDialogView
