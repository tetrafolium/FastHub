...
class RepoCommitsPresenter extends BasePresenter<RepoCommitsMvp.View>
  ...
  @Override
  public void onBranchChanged(@NonNull String branch) {
  ...
  @Override
  public void onItemClick(int position, View v, Commit item) {
    CommitPagerActivity.createIntentForOffline(v.getContext(), item);
  }

  @Override
  public void onItemLongClick(int position, View v, Commit item) {}
