...
public class LoginPresenter
  ...
  @Override
  public void onTokenResponse(@Nullable AccessTokenModel modelResponse) {
  ...
  @Override
  public void onUserResponse(@Nullable Login userModel) {
    if (userModel != null) {
      manageObservable(
  ...
  private void accessTokenLogin(@NonNull String password,
                                @Nullable String endpoint, @Nullable String otp,
