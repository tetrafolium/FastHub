...
public class RepoFilePathFragment
  ...
  newInstance(final @NonNull String login, final @NonNull String repoId,
  ...
  @Override
  public void onNotifyAdapter(final @Nullable List<RepoFile> items,
                              final int page) {
    hideProgress();
  ...
  @Override
  public void onItemClicked(final @NonNull RepoFile model, final int position) {
  ...
  @Override
  public void onAppendPath(final @NonNull RepoFile model) {
    getRepoFilesView().onSetData(
        getPresenter().getLogin(), getPresenter().getRepoId(),
  ...
  @Override
  public void onAppenedtab(final @Nullable RepoFile repoFile) {
    if (repoFile != null) {
  ...
  @Override
  public void onBranchSelected(final @NonNull BranchesModel branch) {
    ref = branch.getName();
    branches.setText(ref);
    getRepoFilesView().onSetData(getPresenter().getLogin(),
