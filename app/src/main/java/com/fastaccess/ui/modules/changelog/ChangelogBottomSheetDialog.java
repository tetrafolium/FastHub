...
public class ChangelogBottomSheetDialog
    extends BaseMvpBottomSheetDialogFragment<ChangelogMvp.View,
                                             ChangelogPresenter>
    implements ChangelogMvp.View {
  ...
  @Override
  public void onChangelogLoaded(final @Nullable String html) {
    showChangelog(html);
  }
