...
public class AssigneesDialogFragment
    extends BaseDialogFragment<AssigneesMvp.View, AssigneesPresenter>
    implements AssigneesMvp.View {
  ...
  public static AssigneesDialogFragment newInstance(final @NonNull String login,
                                                    final
  ...
  public void onAttach(final @NotNull Context context) {
    ...
    if (getParentFragment() instanceof AssigneesMvp.SelectedAssigneesListener) {
      ...
      throw new IllegalArgumentException(
          "Parent Fragment or Activity must implement AssigneesMvp.SelectedAssigneesListener");
    }
  }
  ...
  protected void onFragmentCreated(final @NonNull View view,
    ...
    stateLayout.setEmptyText(isAssinees ? R.string.no_assignees
                                        : R.string.no_reviewers);
  ...
  @Override
  public boolean isAssigneeSelected(final int position) {
    return getSelectionMap().get(position) != null;
  }

  @Override
  public void onToggleSelection(final int position, final boolean select) {
    if (select) {
  ...
  public void onClick(final View view) {
    ...
    case R.id.cancel:
      ...
      break;
    case R.id.ok:
      ArrayList<User> labels =
          Stream.of(selectionMap)
              .filter(value -> value.getValue() != null)
              .map(Map.Entry::getValue)
              .collect(Collectors.toCollection(ArrayList::new));
      callback.onSelectedAssignees(
  ...
  @Override
  public void onNotifyAdapter(final @Nullable List<User> items) {
    hideProgress();
  ...
  private void callApi() {
    ...
    getPresenter().onCallApi(
        getArguments().getString(BundleConstant.EXTRA),
