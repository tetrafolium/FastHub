...
public class AssigneesDialogFragment
  ...
  public static AssigneesDialogFragment newInstance(@NonNull String login,
  ...
  @Override
  public boolean isAssigneeSelected(int position) {
    return getSelectionMap().get(position) != null;
  }

  @Override
  public void onToggleSelection(int position, boolean select) {
    if (select) {
  ...
  @Override
  public void onNotifyAdapter(@Nullable List<User> items) {
    hideProgress();
