...
public class OrgProfileOverviewFragment
    extends BaseFragment<OrgProfileOverviewMvp.View,
                         OrgProfileOverviewPresenter>
  ...
  public static OrgProfileOverviewFragment newInstance(final
  ...
  void onOpenProjects() {
    OrgProjectActivity.Companion.startActivity(
        getContext(), getPresenter().getLogin(), isEnterprise());
  }
  ...
  public void onInitViews(final @Nullable User userModel) {
    ...
    username.setText(InputHelper.isEmpty(userModel.getName())
                         ? userModel.getLogin()
                         : userModel.getName());
    if (userModel.getDescription() != null) {
      description.setText(
          EmojiParser.parseToUnicode(userModel.getDescription()));
    ...
    projects.setVisibility(userModel.isHasOrganizationProjects() ? View.VISIBLE
                                                                 : View.GONE);
  }
