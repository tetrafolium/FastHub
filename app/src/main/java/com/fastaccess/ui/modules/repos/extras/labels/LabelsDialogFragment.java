...
public class LabelsDialogFragment
  ...
  newInstance(@Nullable LabelListModel selectedLabels, @NonNull String repo,
  ...
  @Override
  public void onToggleSelection(LabelModel labelModel, boolean select) {
    if (select) {
  ...
  @Override
  public void onNotifyAdapter(@Nullable List<LabelModel> items, int page) {
    hideProgress();
