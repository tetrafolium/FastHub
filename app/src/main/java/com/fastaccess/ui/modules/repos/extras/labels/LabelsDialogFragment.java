...
public class LabelsDialogFragment
    extends BaseDialogFragment<LabelsMvp.View, LabelsPresenter>
    implements LabelsMvp.View {
  ...
  public static LabelsDialogFragment
  newInstance(final @Nullable LabelListModel selectedLabels,
  ...
  void onAddLabel() {
    ...
    if (!InputHelper.isEmpty(repo) && !InputHelper.isEmpty(login)) {
      CreateLabelDialogFragment.newInstance(login, repo)
          .show(getChildFragmentManager(), "CreateLabelDialogFragment");
    }
  }
  ...
  public LabelsPresenter providePresenter() {
    ...
    return new LabelsPresenter(bundle.getString(BundleConstant.EXTRA_THREE),
                               bundle.getString(BundleConstant.EXTRA_TWO));
  }

  @Override
  public boolean isLabelSelected(final LabelModel labelModel) {
    return labelModels.indexOf(labelModel) != -1;
  }

  @Override
  public void onToggleSelection(final LabelModel labelModel,
  ...
  @Override
  public void onNotifyAdapter(final @Nullable List<LabelModel> items,
                              final int page) {
    hideProgress();
  ...
  @Override
  public void onLabelAdded(final @NonNull LabelModel labelModel) {
