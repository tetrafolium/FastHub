...
public class OrgMembersFragment
    extends BaseFragment<OrgMembersMvp.View, OrgMembersPresenter>
    implements OrgMembersMvp.View {
  ...
  @NonNull
  @Override
  public OrgMembersPresenter providePresenter() {
