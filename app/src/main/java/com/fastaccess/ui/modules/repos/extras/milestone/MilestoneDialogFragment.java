...
public class MilestoneDialogFragment
    extends BaseFragment<MilestoneMvp.View, MilestonePresenter>
    implements MilestoneMvp.View {
  public static final String TAG =
      MilestoneDialogFragment.class.getSimpleName();
  ...
  public void onAttach(final Context context) {
    ...
    if (getParentFragment() != null && getParentFragment() instanceof
      ...
      onMilestoneSelected =
          (MilestoneMvp.OnMilestoneSelected)getParentFragment();
  ...
  @Override
  public void onNotifyAdapter(final @Nullable List<MilestoneModel> items) {
    hideProgress();
  ...
  private boolean onAddMilestone() {
    ...
    CreateMilestoneDialogFragment
        .newInstance(getArguments().getString(BundleConstant.EXTRA),
