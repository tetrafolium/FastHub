...
class RepoIssuesPresenter extends BasePresenter<RepoIssuesMvp.View>
  ...
  @Override
  public boolean onCallApi(int page, @Nullable IssueState parameter) {
    if (parameter == null) {
  ...
  @Override
  public void onSetSortBy(boolean isLastUpdated) {
  ...
  @Override
  public void onItemLongClick(int position, View v, Issue item) {
    if (getView() != null)
  ...
  private Observable<List<Issue>> grabMoreIssues(@NonNull List<Issue> issues,
