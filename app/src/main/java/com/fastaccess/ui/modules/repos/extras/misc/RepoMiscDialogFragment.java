...
public class RepoMiscDialogFragment
    extends BaseDialogFragment<RepoMiscMVp.View, RepoMiscPresenter>
    implements RepoMiscMVp.View {
  ...
  private static RepoMiscDialogFragment
  newInstance(final @NonNull String owner, final @NonNull String repo,
              final @RepoMiscMVp.MiscType int type) {
  ...
  public static void show(final @NonNull FragmentManager fragmentManager,
                          final @NonNull String owner,
                          final @NonNull String repo,
                          final @RepoMiscMVp.MiscType int type) {
    newInstance(owner, repo, type)
        .show(fragmentManager, RepoMiscDialogFragment.class.getName());
  }
  ...
  protected void onFragmentCreated(final @NonNull View view,
    ...
    case RepoMiscMVp.FORKS:
      ...
      stateLayout.setEmptyText(String.format("%s %s", getString(R.string.no),
