...
class StarredGistsPresenter extends BasePresenter<StarredGistsMvp.View>
    implements StarredGistsMvp.Presenter {
  ...
  public boolean onCallApi(int page, @Nullable String parameter) {
    ...
    makeRestCall(
        RestProvider.getGistService(isEnterprise()).getStarredGists(page),
        listResponse -> {
  ...
  @Override
  public void onWorkOffline(@NonNull String login) {} // do nothing for now.
