...
public class PinnedPullRequestFragment
    extends BaseFragment<PinnedPullRequestMvp.View, PinnedPullRequestPresenter>
    implements PinnedPullRequestMvp.View {

  public static final String TAG =
      PinnedPullRequestFragment.class.getSimpleName();
  ...
  @Override
  public void onNotifyAdapter(@Nullable List<PullRequest> items) {
  ...
  @Override
  public void onDeletePinnedPullRequest(long id, int position) {
    MessageDialogView
  ...
  protected void onFragmentCreated(@NonNull View view,
    ...
    adapter = new PullRequestAdapter(getPresenter().getPinnedPullRequest(),
                                     true, true);
