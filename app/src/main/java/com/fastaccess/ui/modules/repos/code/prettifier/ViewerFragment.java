...
public class ViewerFragment
  ...
  public static ViewerFragment
  newInstance(@NonNull String url, @Nullable String htmlUrl, boolean isRepo) {
  ...
  @Override
  public void onSetMdText(@NonNull String text, String baseUrl,
                          boolean replace) {
    webView.setVisibility(View.VISIBLE);
