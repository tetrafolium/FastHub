...
public class ViewerFragment
    extends BaseFragment<ViewerMvp.View, ViewerPresenter>
    implements ViewerMvp.View, AppBarLayout.OnOffsetChangedListener {
  ...
  public static ViewerFragment newInstance(final @NonNull String url,
                                           final @Nullable String htmlUrl) {
    return newInstance(url, htmlUrl, false);
  }

  public static ViewerFragment newInstance(final @NonNull String url,
                                           final boolean isRepo) {
  ...
  @Override
  public void onSetImageUrl(final @NonNull String url, final boolean isSvg) {
  ...
  @Override
  public void onSetMdText(final @NonNull String text, final String baseUrl,
  ...
  @Override
  public void onSetCode(final @NonNull String text) {
    webView.setVisibility(View.VISIBLE);
    loader.setIndeterminate(false);
  ...
  @Override
  public void onShowError(final @NonNull String msg) {
    hideProgress();
    showErrorMessage(msg);
  }

  @Override
  public void onShowError(final @StringRes int msg) {
    hideProgress();
  ...
  @Override
  public void openUrl(final @NonNull String url) {
  ...
  @Override
  public void onContentChanged(final int progress) {
    if (loader != null) {
  ...
  @Override
  public void onScrollChanged(final boolean reachedTop, final int scroll) {
  ...
  protected void onFragmentCreated(final @NonNull View view,
    ...
    stateLayout.setOnReloadListener(
        view1 -> getPresenter().onHandleIntent(getArguments()));
