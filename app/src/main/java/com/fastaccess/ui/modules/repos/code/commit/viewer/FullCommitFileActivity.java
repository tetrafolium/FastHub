...
public class FullCommitFileActivity extends BaseActivity {
  ...
  public static void start(final @NonNull Context context,
                           final @NonNull CommitFileModel fileModel) {
    Intent starter = new Intent(context, FullCommitFileActivity.class);
    starter.putExtras(
        Bundler.start().put(BundleConstant.ITEM, fileModel).end());
  ...
  protected void onCreate(final Bundle savedInstanceState) {
    ...
    if (savedInstanceState == null) {
      commitFileModel =
          getIntent().getExtras().getParcelable(BundleConstant.ITEM);
    }
    ...
    textView.setText(DiffLineSpan.getSpannable(
        commitFileModel.getPatch(), ViewHelper.getPatchAdditionColor(this),
  ...
  public boolean onOptionsItemSelected(final MenuItem item) {
    ...
    case R.id.open:
      startActivity(CodeViewerActivity.createIntent(
          this, commitFileModel.getContentsUrl(),
          commitFileModel.getBlobUrl()));
      return true;
    case R.id.share:
