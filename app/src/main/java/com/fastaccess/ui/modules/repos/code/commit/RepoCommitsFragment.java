...
public class RepoCommitsFragment
    extends BaseFragment<RepoCommitsMvp.View, RepoCommitsPresenter>
    implements RepoCommitsMvp.View {
  ...
  public static RepoCommitsFragment newInstance(@NonNull String repoId,
  ...
  @Override
  public void onNotifyAdapter(@Nullable List<Commit> items, int page) {
    hideProgress();
  ...
  @NonNull
  @Override
  public RepoCommitsPresenter providePresenter() {
  ...
  @Override
  public void setBranchesData(@Nullable List<BranchesModel> branchesData,
                              boolean firstTime) {}

  @Override
  public void onShowCommitCount(long sum) {
