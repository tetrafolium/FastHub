...
public class RepoCommitsFragment
  ...
  public static RepoCommitsFragment newInstance(final @NonNull String repoId,
  ...
  @Override
  public void onNotifyAdapter(final @Nullable List<Commit> items,
                              final int page) {
    hideProgress();
  ...
  @Override
  public void setBranchesData(final @Nullable List<BranchesModel> branchesData,
                              final boolean firstTime) {}

  @Override
  public void onShowCommitCount(final long sum) {
