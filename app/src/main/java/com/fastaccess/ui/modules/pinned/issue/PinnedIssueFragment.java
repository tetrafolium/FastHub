...
public class PinnedIssueFragment
    extends BaseFragment<PinnedIssueMvp.View, PinnedIssuePresenter>
    implements PinnedIssueMvp.View {
  ...
  @Override
  public void onNotifyAdapter(@Nullable List<Issue> items) {
  ...
  @Override
  public void onDeletePinnedIssue(long id, int position) {
    MessageDialogView
  ...
  protected void onFragmentCreated(@NonNull View view,
    ...
    adapter =
        new IssuesAdapter(getPresenter().getPinnedIssue(), true, true, true);
