...
public class SearchReposFragment
    extends BaseFragment<SearchReposMvp.View, SearchReposPresenter>
    implements SearchReposMvp.View {
  ...
  protected void onFragmentCreated(final @NonNull View view,
    ...
    if (!InputHelper.isEmpty(searchQuery) &&
        getPresenter().getRepos().isEmpty() && !getPresenter().isApiCalled()) {
      onRefresh();
    }
    if (InputHelper.isEmpty(searchQuery)) {
  ...
  @NonNull
  @Override
  public SearchReposPresenter providePresenter() {
