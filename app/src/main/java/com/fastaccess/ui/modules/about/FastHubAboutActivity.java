...
public class FastHubAboutActivity extends MaterialAboutActivity {
  ...
  @NonNull
  @Override
  protected MaterialAboutList getMaterialAboutList(final
    ...
    MaterialAboutCard.Builder authorCardBuilder =
    ...
    return new MaterialAboutList(
        appCardBuilder.build(), miscCardBuilder.build(),
        authorCardBuilder.build(), newLogoAuthor.build(), logoAuthor.build());
  }
  ...
  private void buildLogo(final Context context,
                         final MaterialAboutCard.Builder newLogoAuthor,
                         final MaterialAboutCard.Builder logoAuthor) {
                ...
                .setOnClickAction(
                    ()
                        -> ActivityHelper.startCustomTab(
                            this, "https://plus.google.com/+CookiconsDesign"))
                .build())
        .addItem(
            new MaterialAboutActionItem.Builder()
                ...
                .setOnClickAction(()
                                      -> ActivityHelper.startCustomTab(
                                          this, "https://twitter.com/mcookie"))
                .build())
        .addItem(
            new MaterialAboutActionItem.Builder()
                ...
                .setOnClickAction(()
                                      -> ActivityHelper.startCustomTab(
                                          this, "https://cookicons.co/"))
                .build());

    logoAuthor.title(String.format(
        "Old %s", getString(R.string.logo_designer, "Kevin Aguilar")));
    logoAuthor
        .addItem(
            new MaterialAboutActionItem.Builder()
                .text(R.string.google_plus)
                ...
                .setOnClickAction(
                    ()
                        -> ActivityHelper.startCustomTab(
                            this, "https://plus.google.com/+KevinAguilarC"))
                .build())
        .addItem(
            new MaterialAboutActionItem.Builder()
                .text(R.string.twitter)
                ...
                .setOnClickAction(()
                                      -> ActivityHelper.startCustomTab(
                                          this, "https://twitter.com/kevttob"))
                .build())
        .addItem(
            new MaterialAboutActionItem.Builder()
                .text(R.string.website)
                ...
                .setOnClickAction(()
                                      -> ActivityHelper.startCustomTab(
                                          this, "http://kevaguilar.com/"))
                .build());
  }

  private void buildAuthor(final Context context,
                           final MaterialAboutCard.Builder authorCardBuilder) {
            ...
            new MaterialAboutActionItem.Builder()
                ...
                .setOnClickAction(()
                                      -> UserPagerActivity.startActivity(
                                          context, "k0shk0sh", false, false, 0))
                .build())
        .addItem(
            new MaterialAboutActionItem.Builder()
                ...
                .setOnClickAction(
                    ()
                        -> startActivity(RepoPagerActivity.createIntent(
                            this, "FastHub", "k0shk0sh")))
                .build())
        .addItem(ConvenienceBuilder.createEmailItem(
            context, ContextCompat.getDrawable(context, R.drawable.ic_email),
            getString(R.string.send_email), true,
            getString(R.string.email_address),
            getString(R.string.question_concerning_fasthub)));
  }

  private void buildMisc(final Context context,
                         final MaterialAboutCard.Builder miscCardBuilder) {
            ...
            new MaterialAboutActionItem.Builder()
                ...
                .setOnClickAction(()
                                      -> startActivity(new Intent(
                                          context, DonationActivity.class)))
                .build())
        .addItem(
            new MaterialAboutActionItem.Builder()
                .text(R.string.changelog)
                .icon(ContextCompat.getDrawable(context,
                                                R.drawable.ic_track_changes))
                .setOnClickAction(()
                                      -> new ChangelogBottomSheetDialog().show(
            ...
            new MaterialAboutActionItem.Builder()
                ...
                .setOnClickAction(
                    ()
                        -> new LibsBuilder()
                               .withActivityStyle(
                                   AppHelper.isNightMode(getResources())
                                       ? Libs.ActivityStyle.DARK
                                       : Libs.ActivityStyle.LIGHT)
                               .withAutoDetect(true)
                               .withActivityTitle(this.getResources().getString(
                                   R.string.open_source_libs))
  ...
  private void buildApp(final Context context,
                        final MaterialAboutCard.Builder appCardBuilder) {
    appCardBuilder
        .addItem(
            new MaterialAboutActionItem.Builder()
                ...
                .setOnClickAction(()
                                      -> startService(new Intent(
                                          this, CheckVersionService.class)))
                .build())
                ...
                .setOnClickAction(
                    ()
                        -> CreateIssueActivity.startForResult(
                            this, CreateIssueActivity.startForResult(this),
                            malRecyclerview))
                .build());
  }
}
