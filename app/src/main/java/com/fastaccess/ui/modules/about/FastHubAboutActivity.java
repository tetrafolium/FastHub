...
public class FastHubAboutActivity extends MaterialAboutActivity {
  ...
  private void buildLogo(Context context,
                         MaterialAboutCard.Builder newLogoAuthor,
                         MaterialAboutCard.Builder logoAuthor) {
  ...
  private void buildAuthor(Context context,
                           MaterialAboutCard.Builder authorCardBuilder) {
  ...
  private void buildMisc(Context context,
                         MaterialAboutCard.Builder miscCardBuilder) {
  ...
  private void buildApp(Context context,
                        MaterialAboutCard.Builder appCardBuilder) {
    appCardBuilder
        .addItem(
            new MaterialAboutActionItem.Builder()
