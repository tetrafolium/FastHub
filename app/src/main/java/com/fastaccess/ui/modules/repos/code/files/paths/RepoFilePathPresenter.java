...
class RepoFilePathPresenter extends BasePresenter<RepoFilePathMvp.View>
    implements RepoFilePathMvp.Presenter {
  ...
  public void onFragmentCreated(@Nullable Bundle bundle) {
    if (bundle != null) {
      ...
      defaultBranch = Objects.toString(
      ...
      if (InputHelper.isEmpty(repoId) || InputHelper.isEmpty(login)) {
        throw new NullPointerException(String.format(
            "error, repoId(%s) or login(%s) is null", repoId, login));
      }
