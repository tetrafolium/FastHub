...
public class GistFilesListFragment
  ...
  newInstance(final @NonNull ArrayList<FilesListModel> files,
  ...
  @Override
  public void onOpenFile(final @NonNull FilesListModel item,
                         final int position) {
  ...
  @Override
  public void onDeleteFile(final @NonNull FilesListModel item,
                           final int position) {
    MessageDialogView
  ...
  @Override
  public void onEditFile(final @NonNull FilesListModel item,
                         final int position) {
  ...
  @Override
  public void onInitFiles(final
                          @Nullable ArrayList<FilesListModel> filesListModel,
                          final boolean isOwner) {
  ...
  @Override
  public void onFileAdded(final @NonNull FilesListModel file,
