...
interface RepoFilesMvp {
  ...
  interface View extends BaseMvp.FAView, SwipeRefreshLayout.OnRefreshListener,
                         DeleteContentFileCallback {
    void onNotifyAdapter();

    void onItemClicked(@NonNull RepoFile model);

    void onMenuClicked(int position, @NonNull RepoFile model,
                       android.view.View view);

    void onSetData(@NonNull String login, @NonNull String repoId,
                   @NonNull String path, @NonNull String ref, boolean clear,
                   @Nullable RepoFile toAppend);
  ...
  interface Presenter extends BaseMvp.FAPresenter,
    ...
    void onInitDataAndRequest(@NonNull String login, @NonNull String repoId,
                              @NonNull String path, @NonNull String ref,
                              boolean clear, @Nullable RepoFile toAppend);

    @Nullable
    List<RepoFile> getCachedFiles(@NonNull String url, @NonNull String ref);
