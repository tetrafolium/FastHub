...
public class MyIssuesFragment
    extends BaseFragment<MyIssuesMvp.View, MyIssuesPresenter>
    implements MyIssuesMvp.View {
  ...
  @Override
  public void onNotifyAdapter(@Nullable List<Issue> items, int page) {
    hideProgress();
  ...
  protected void onFragmentCreated(@NonNull View view,
    ...
    if (savedInstanceState == null || (getPresenter().getIssues().isEmpty() &&
  ...
  @Override
  public void onShowPopupDetails(@NonNull Issue item) {
  ...
  private MyIssuesType getIssuesType() {
    if (issuesType == null) {
      issuesType = (MyIssuesType)getArguments().getSerializable(
