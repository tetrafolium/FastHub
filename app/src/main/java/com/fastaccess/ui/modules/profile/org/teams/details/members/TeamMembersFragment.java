...
public class TeamMembersFragment
    extends BaseFragment<TeamMembersMvp.View, TeamMembersPresenter>
    implements TeamMembersMvp.View {
  ...
  public static TeamMembersFragment newInstance(final @NonNull Long id) {
  ...
  public OnLoadMore<Long> getLoadMore() {
    if (onLoadMore == null) {
      onLoadMore = new OnLoadMore<>(
          getPresenter(), getArguments().getLong(BundleConstant.EXTRA));
    }
    return onLoadMore;
  }
