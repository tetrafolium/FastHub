...
public class PullRequestTimelineFragment
  ...
  @Override
  protected void onFragmentCreated(@NonNull View view,
  ...
  @Override
  public void onNotifyAdapter(@Nullable List<TimelineModel> items, int page) {
    hideProgress();
    if (items == null) {
  ...
  @Override
  public void onEditComment(@NonNull Comment item) {
  ...
  @Override
  public void onEditReviewComment(@NonNull ReviewCommentModel item,
  ...
  @Override
  public void onRemove(@NonNull TimelineModel timelineModel) {
    hideProgress();
  ...
  @Override
  public void onReplyOrCreateReview(@Nullable User user,
                                    @Nullable String message, int groupPosition,
                                    int childPosition,
  ...
  @Override
  public void addComment(@NonNull TimelineModel timelineModel) {
  ...
  @Override
  public void showReactionsPopup(@NonNull ReactionTypes type,
  ...
  @Override
  public void onShowReviewDeleteMsg(long commentId, int groupPosition,
                                    int commentPosition) {
    MessageDialogView
        .newInstance(getString(R.string.delete),
                     getString(R.string.confirm_message),
  ...
  @Override
  public void onSetHeader(@NonNull TimelineModel timelineModel) {
    if (adapter != null) {
      if (adapter.isEmpty()) {
  ...
  @Override
  public boolean isPreviouslyReacted(long id, int vId) {
