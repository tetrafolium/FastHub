...
public class PullRequestTimelineFragment
    extends BaseFragment<PullRequestTimelineMvp.View,
                         PullRequestTimelinePresenter>
  ...
  @NonNull
  public static PullRequestTimelineFragment newInstance() {
  ...
  public void onAttach(final Context context) {
    ...
    if (getParentFragment() instanceof CommentEditorFragment.CommentListener) {
      commentsCallback =
          (CommentEditorFragment.CommentListener)getParentFragment();
  ...
  protected void onFragmentCreated(final @NonNull View view,
    ...
    adapter = new IssuesTimelineAdapter(
        getPresenter().getEvents(), this, true, this, isMerged, getPresenter(),
        getPullRequest().getLogin(), getPullRequest().getUser().getLogin());
    ...
    if (savedInstanceState == null) {
      ...
      onRefresh();
    } else if (getPresenter().getEvents().isEmpty() ||
               getPresenter().getEvents().size() == 1) {
      onRefresh();
    }
  }
  ...
  @NonNull
  @Override
  public PullRequestTimelinePresenter providePresenter() {
  ...
  @Override
  public void onNotifyAdapter(final @Nullable List<TimelineModel> items,
                              final int page) {
    hideProgress();
    if (items == null) {
  ...
  @NonNull
  @Override
  public OnLoadMore<PullRequest> getLoadMore() {
    if (onLoadMore == null) {
  ...
  @Override
  public void onEditComment(final @NonNull Comment item) {
    ...
    intent.putExtras(
        Bundler.start()
            ...
            .put(BundleConstant.EXTRA_TYPE,
                 BundleConstant.ExtraType.EDIT_ISSUE_COMMENT_EXTRA)
            .putStringArrayList(
                "participants",
                CommentsHelper.getUsersByTimeline(adapter.getData()))
  ...
  @Override
  public void onEditReviewComment(final @NonNull ReviewCommentModel item,
    ...
    ActivityHelper.startReveal(this, intent, view,
                               BundleConstant.REVIEW_REQUEST_CODE);
  }

  @Override
  public void onRemove(final @NonNull TimelineModel timelineModel) {
    hideProgress();
    adapter.removeItem(timelineModel);
  }

  @Override
  public void onShowDeleteMsg(final long id) {
    MessageDialogView
  ...
  @Override
  public void onReply(final User user, final String message) {
    Intent intent = new Intent(getContext(), EditorActivity.class);
    if (getPullRequest() == null)
      return;
    intent.putExtras(
  ...
  @Override
  public void
  onReplyOrCreateReview(final @Nullable User user,
                        final @Nullable String message, final int groupPosition,
                        final int childPosition,
                        final @NonNull EditReviewCommentModel model) {
    Intent intent = new Intent(getContext(), EditorActivity.class);
    if (getPullRequest() == null)
      return;
    intent.putExtras(
  ...
  @Override
  public void addComment(final @NonNull TimelineModel timelineModel) {
    onHideBlockingProgress();
    adapter.addItem(timelineModel);
    if (commentsCallback != null)
      commentsCallback.onClearEditText();
  }
  ...
  @Override
  public void
  showReactionsPopup(final @NonNull ReactionTypes type,
                     final @NonNull String login, final @NonNull String repoId,
                     final long idOrNumber, final int reactionType) {
    ReactionsDialogFragment
        .newInstance(login, repoId, type, idOrNumber, reactionType)
        .show(getChildFragmentManager(), "ReactionsDialogFragment");
  }

  @Override
  public void onShowReviewDeleteMsg(final long commentId,
                                    final int groupPosition,
  ...
  @Override
  public void onRemoveReviewComment(final int groupPosition,
                                    final int commentPosition) {
    hideProgress();
    TimelineModel timelineModel = adapter.getItem(groupPosition);
    if ((timelineModel != null &&
        timelineModel.getGroupedReviewModel() != null) && (timelineModel.getGroupedReviewModel().getComments() != null)) {
      timelineModel.getGroupedReviewModel().getComments().remove(
          commentPosition);
  ...
  @Override
  public void onSetHeader(final @NonNull TimelineModel timelineModel) {
    if (adapter != null) {
      if (adapter.isEmpty()) {
    ...
    if (resultCode == Activity.RESULT_OK) {
      ...
      if (bundle != null) {
        ...
        if (requestCode == BundleConstant.REQUEST_CODE) {
          ...
          EditReviewCommentModel commentModel =
          ...
          TimelineModel timelineModel =
              adapter.getItem(commentModel.getGroupPosition());
          if (isNew) {
            if (timelineModel.getGroupedReviewModel() != null &&
                timelineModel.getGroupedReviewModel().getComments() != null) {
              timelineModel.getGroupedReviewModel().getComments().add(
            ...
            if (timelineModel.getGroupedReviewModel() != null &&
                timelineModel.getGroupedReviewModel().getComments() != null) {
              timelineModel.getGroupedReviewModel().getComments().set(
                  commentModel.getCommentPosition(),
                  commentModel.getCommentModel());
              adapter.notifyItemChanged(commentModel.getGroupPosition());
            } else {
              onRefresh();
  ...
  @Override
  public boolean isPreviouslyReacted(final long id, final int vId) {
  ...
  private View getFromView() {
    return getActivity() != null && getActivity().findViewById(R.id.fab) != null
