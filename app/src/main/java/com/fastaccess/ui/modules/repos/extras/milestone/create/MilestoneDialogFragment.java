...
public class MilestoneDialogFragment
    extends BaseDialogFragment implements MilestoneMvp.OnMilestoneSelected {
  ...
  public static MilestoneDialogFragment
  ...
  public void onAttach(final @NotNull Context context) {
    ...
    } else if (getParentFragment() instanceof
  ...
  protected void onFragmentCreated(final @NonNull View view,
    ...
    if (savedInstanceState == null) {
      ...
      com.fastaccess.ui.modules.repos.extras.milestone
          .MilestoneDialogFragment milestoneView =
          new com.fastaccess.ui.modules.repos.extras.milestone
              .MilestoneDialogFragment();
      milestoneView.setArguments(bundle);
      getChildFragmentManager()
          .beginTransaction()
          .replace(R.id.singleContainer, milestoneView,
                   com.fastaccess.ui.modules.repos.extras.milestone
                       .MilestoneDialogFragment.TAG)
          .commit();
    }
  }
  ...
  public void onMilestoneSelected(final
    ...
    if (issueCallback != null)
      issueCallback.onMileStoneSelected(milestoneModel);
    if (pullRequestCallback != null)
      pullRequestCallback.onMileStoneSelected(milestoneModel);
    if (milestoneCallback != null)
      milestoneCallback.onMilestoneSelected(milestoneModel);
  }
}
