...
public class MyIssuesPagerFragment
    extends BaseFragment<MyIssuesPagerMvp.View, MyIssuesPagerPresenter>
    implements MyIssuesPagerMvp.View {
  ...
  @NonNull
  @Override
  public MyIssuesPagerPresenter providePresenter() {
  ...
  @Nullable
  private TabsCountStateModel getModelAtIndex(int index) {
  ...
  public void onScrollTop(int index) {
    ...
    if (pager != null && pager.getAdapter() != null) {
      MyIssuesFragment myIssuesFragment =
          (MyIssuesFragment)pager.getAdapter().instantiateItem(
  ...
  private void onShowFilterMenu(@Nullable TabsCountStateModel model,
                                TextView tv) {
    if (model == null)
      return;
