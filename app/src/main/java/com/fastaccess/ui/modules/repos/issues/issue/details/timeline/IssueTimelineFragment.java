...
public class IssueTimelineFragment
  ...
  @NonNull
  public static IssueTimelineFragment newInstance(long commentId) {
  ...
  @Override
  public void onStartNewComment(String text) {
    onTagUser(null);
  }
  ...
  @Override
  public void onTagUser(@Nullable User user) {
  ...
  public void showReactionsPopup(@NonNull ReactionTypes type,
                                 ...
                                 long idOrNumber, boolean isHeader) {
  ...
  @Override
  public void addNewComment(@NonNull TimelineModel timelineModel) {
  ...
  @Override
  public void addComment(@Nullable TimelineModel timelineModel, int index) {
