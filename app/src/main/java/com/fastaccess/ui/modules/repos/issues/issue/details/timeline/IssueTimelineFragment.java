...
public class IssueTimelineFragment
    extends BaseFragment<IssueTimelineMvp.View, IssueTimelinePresenter>
    implements IssueTimelineMvp.View {
  ...
  @NonNull
  public static IssueTimelineFragment newInstance(final long commentId) {
    IssueTimelineFragment fragment = new IssueTimelineFragment();
    fragment.setArguments(
        Bundler.start().put(BundleConstant.ID, commentId).end());
    return fragment;
  }
  ...
  protected void onFragmentCreated(final @NonNull View view,
    ...
    if (issueCallback != null && issueCallback.getData() != null) {
      adapter = new IssuesTimelineAdapter(
          getPresenter().getEvents(), this, true, this,
          issueCallback.getData().getLogin(),
          issueCallback.getData().getUser().getLogin());
    } else {
      adapter = new IssuesTimelineAdapter(getPresenter().getEvents(), this,
                                          true, this, "", "");
    }
  ...
  public void onEditComment(final @NonNull Comment item) {
    ...
    intent.putExtras(
        Bundler.start()
            ...
            .end());
    View view =
        getActivity() != null && getActivity().findViewById(R.id.fab) != null
  ...
  @Override
  public void onStartNewComment(final String text) {
    onTagUser(null);
  }
  ...
  @Override
  public void onTagUser(final @Nullable User user) {
  ...
  showReactionsPopup(final @NonNull ReactionTypes type,
                     ...
                     final long idOrNumber, final boolean isHeader) {
    ReactionsDialogFragment
        .newInstance(login, repoId, type, idOrNumber,
                     isHeader ? ReactionsProvider.HEADER
  ...
  @Override
  public void addNewComment(final @NonNull TimelineModel timelineModel) {
  ...
  public long getCommentId() {
    return getArguments() != null ? getArguments().getLong(BundleConstant.ID)
                                  : 0;
  }

  @Override
  public void addComment(final @Nullable TimelineModel timelineModel,
                         final int index) {
