...
public class GistCommentsFragment
    extends BaseFragment<GistCommentsMvp.View, GistCommentsPresenter>
    implements GistCommentsMvp.View {
  ...
  @Override
  public void onNotifyAdapter(final @Nullable List<Comment> items,
                              final int page) {
    hideProgress();
  ...
  @Override
  public void onRemove(final @NonNull Comment comment) {
    hideProgress();
    ...
    intent.putExtras(
        Bundler.start()
            ...
            .putStringArrayList("participants",
                                CommentsHelper.getUsers(adapter.getData()))
  ...
  @Override
  public void onAddNewComment(final @NonNull Comment comment) {
