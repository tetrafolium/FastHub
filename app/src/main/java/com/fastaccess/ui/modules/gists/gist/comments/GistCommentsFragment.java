...
public class GistCommentsFragment
  ...
  @Override
  public void onNotifyAdapter(@Nullable List<Comment> items, int page) {
    hideProgress();
  ...
  @Override
  public void onRemove(@NonNull Comment comment) {
    hideProgress();
  ...
  @Override
  public void onAddNewComment(@NonNull Comment comment) {
