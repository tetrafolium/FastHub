...
public class SearchCodeFragment
  ...
  @Override
  public void onNotifyAdapter(@Nullable List<SearchCodeModel> items, int page) {
    hideProgress();
  ...
  @Override
  public void onSetSearchQuery(@NonNull String query, boolean showRepoName) {
  ...
  @Override
  public void onItemClicked(@NonNull SearchCodeModel item) {
    if (item.getUrl() != null) {
