...
public class SearchCodeFragment
    extends BaseFragment<SearchCodeMvp.View, SearchCodePresenter>
    implements SearchCodeMvp.View {
  ...
  @Override
  public void onNotifyAdapter(final @Nullable List<SearchCodeModel> items,
                              final int page) {
    hideProgress();
  ...
  @Override
  public void onSetTabCount(final int count) {
  ...
  protected void onFragmentCreated(final @NonNull View view,
    ...
    if (!InputHelper.isEmpty(searchQuery) &&
        getPresenter().getCodes().isEmpty() && !getPresenter().isApiCalled()) {
      onRefresh();
    }
    if (InputHelper.isEmpty(searchQuery)) {
  ...
  @Override
  public void onSetSearchQuery(final @NonNull String query,
  ...
  @Override
  public void onQueueSearch(final @NonNull String query) {
    this.searchQuery = query;
    if (getView() != null)
  ...
  @Override
  public void onItemClicked(final @NonNull SearchCodeModel item) {
    if (item.getUrl() != null) {
