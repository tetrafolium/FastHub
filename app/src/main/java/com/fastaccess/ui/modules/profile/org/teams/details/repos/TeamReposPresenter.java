...
class TeamReposPresenter
    extends BasePresenter<TeamReposMvp.View> implements TeamReposMvp.Presenter {
  ...
  @Override
  public boolean onCallApi(final int page, final @Nullable Long parameter) {
    if (parameter == null) {
