...
public class RepoPullRequestPagerFragment
    extends BaseFragment<RepoPullRequestPagerMvp.View,
                         RepoPullRequestPagerPresenter>
    implements RepoPullRequestPagerMvp.View {

  public static final String TAG =
      RepoPullRequestPagerFragment.class.getSimpleName();
  ...
  public static RepoPullRequestPagerFragment
  ...
  protected void onFragmentCreated(@NonNull View view,
    ...
    pager.setAdapter(new FragmentsPagerAdapter(
        ...
        FragmentPagerAdapterModel.buildForRepoPullRequest(getContext(), login,
                                                          repoId)));
  ...
  @NonNull
  @Override
  public RepoPullRequestPagerPresenter providePresenter() {
