...
public class ProfileGistsFragment
    extends BaseFragment<ProfileGistsMvp.View, ProfileGistsPresenter>
    implements ProfileGistsMvp.View {
  ...
  @Override
  public void onNotifyAdapter(@Nullable List<Gist> items, int page) {
    hideProgress();
  ...
  @NonNull
  @Override
  public ProfileGistsPresenter providePresenter() {
  ...
  @Override
  public void onStartGistView(@NonNull String gistId) {
