...
public class CreateMilestoneDialogFragment
  ...
  newInstance(@NonNull String login, @NonNull String repo) {
  ...
  @Override
  public void onShowTitleError(boolean isError) {
    title.setError(isError ? getString(R.string.required_field) : null);
  }

  @Override
  public void onMilestoneAdded(@NonNull MilestoneModel milestoneModel) {
    hideProgress();
