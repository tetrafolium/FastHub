...
class CreateGistPresenter extends BasePresenter<CreateGistMvp.View>
  ...
  @Override
  public void onSubmit(@NonNull String description,
  ...
  @Override
  public void onSubmit(@NonNull CreateGistModel model) {
  ...
  @Override
  public void onSubmitUpdate(@NonNull String id, @NonNull String description,
                             @NonNull HashMap<String, FilesListModel> files) {
