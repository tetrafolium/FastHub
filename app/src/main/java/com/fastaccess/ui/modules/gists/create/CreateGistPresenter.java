...
class CreateGistPresenter extends BasePresenter<CreateGistMvp.View>
    implements CreateGistMvp.Presenter {
  @Override
  public void onSubmit(final @NonNull String description,
                       final @NonNull HashMap<String, FilesListModel> files,
  ...
  @Override
  public void onSubmit(final @NonNull CreateGistModel model) {
  ...
  @Override
  public void
  onSubmitUpdate(final @NonNull String id, final @NonNull String description,
                 final @NonNull HashMap<String, FilesListModel> files) {
