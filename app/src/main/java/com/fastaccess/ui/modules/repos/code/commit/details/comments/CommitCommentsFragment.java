...
public class CommitCommentsFragment
  ...
  public static CommitCommentsFragment newInstance(@NonNull String login,
  ...
  @Override
  public void onRemove(@NonNull TimelineModel comment) {
    hideProgress();
  ...
  @Override
  public void showReactionsPopup(@NonNull ReactionTypes reactionTypes,
