...
public class CommitCommentsFragment
    extends BaseFragment<CommitCommentsMvp.View, CommitCommentsPresenter>
    implements CommitCommentsMvp.View {
  ...
  public static CommitCommentsFragment newInstance(final @NonNull String login,
  ...
  protected void onFragmentCreated(final @NonNull View view,
    ...
    adapter = new IssuesTimelineAdapter(
        getPresenter().getComments(), this, true, this,
        getArguments().getString(BundleConstant.EXTRA), null);
  ...
  @Override
  public void onRemove(final @NonNull TimelineModel comment) {
    hideProgress();
  ...
  public void onTagUser(final @Nullable User user) {
    ...
    intent.putExtras(Bundler.start()
                         ...
                         .putStringArrayList("participants",
                                             CommentsHelper.getUsersByTimeline(
                                                 adapter.getData()))
                         .put(BundleConstant.IS_ENTERPRISE, isEnterprise())
                         .end());
    View view =
  ...
  @Override
  public void showReactionsPopup(final @NonNull ReactionTypes reactionTypes,
                                 final @NonNull String login,
                                 final @NonNull String repoId,
                                 final long commentId) {
    ReactionsDialogFragment
        .newInstance(login, repoId, reactionTypes, commentId,
                     ReactionsProvider.COMMIT)
        .show(getChildFragmentManager(), "ReactionsDialogFragment");
  }

  @Override
  public void addComment(final @NonNull Comment newComment) {
