...
public class OrgProfileOverviewPresenter
    extends BasePresenter<OrgProfileOverviewMvp.View>
    implements OrgProfileOverviewMvp.Presenter {
  ...
  public void onFragmentCreated(final @Nullable Bundle bundle) {
    ...
    if (login != null) {
      makeRestCall(
          RestProvider.getOrgService(isEnterprise()).getOrganization(login),
