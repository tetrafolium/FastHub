...
class PullRequestCommitsPresenter
    extends BasePresenter<PullRequestCommitsMvp.View>
    implements PullRequestCommitsMvp.Presenter {
  ...
  public void onWorkOffline() {
    if (commits.isEmpty()) {
      manageDisposable(
          RxHelper.getSingle(Commit.getCommits(repoId, login, number))
              .subscribe(
                  models
