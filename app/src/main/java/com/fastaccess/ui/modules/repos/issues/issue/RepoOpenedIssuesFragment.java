...
public class RepoOpenedIssuesFragment
  ...
  public static RepoOpenedIssuesFragment newInstance(@NonNull String repoId,
  ...
  @Override
  public void onOpenIssue(@NonNull PullsIssuesParser parser) {
  ...
  @Override
  public void onRefresh(boolean isLastUpdated) {
    getPresenter().onSetSortBy(isLastUpdated);
    getPresenter().onCallApi(1, IssueState.open);
  }

  @Override
  public void onShowIssuePopup(@NonNull Issue item) {
