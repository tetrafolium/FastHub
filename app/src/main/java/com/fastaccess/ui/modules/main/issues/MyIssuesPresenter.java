...
public class MyIssuesPresenter
    extends BasePresenter<MyIssuesMvp.View> implements MyIssuesMvp.Presenter {
  ...
  MyIssuesPresenter() { setEnterprise(PrefGetter.isEnterprise()); }
  ...
  @Override
  public void onSetIssueType(@NonNull MyIssuesType issuesType) {
  ...
  public boolean onCallApi(int page, @Nullable IssueState parameter) {
    ...
    makeRestCall(
        RestProvider.getIssueService(isEnterprise())
            .getIssuesWithCount(getUrl(parameter), page),
        issues -> {
