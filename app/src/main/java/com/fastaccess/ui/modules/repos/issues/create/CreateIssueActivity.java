...
public class CreateIssueActivity
  ...
  @NonNull
  public static Intent startForResult(@NonNull Activity activity) {
  ...
  @Override
  public void onSetCode(@NonNull CharSequence charSequence) {
    this.savedText = charSequence;
    MarkDownProvider.setMdText(description, InputHelper.toString(savedText));
  }

  @Override
  public void onTitleError(boolean isEmptyTitle) {
