...
public class FilterIssueFragment
    extends BaseFragment<FilterIssuesMvp.View, FilterIssuePresenter>
    implements FilterIssuesMvp.View {
  ...
  @Override
  public void onSearch(@NonNull String query, boolean isOpen, boolean isIssue,
  ...
  @Override
  public void onItemClicked(@NonNull Issue item) {
  ...
  @NonNull
  @Override
  public FilterIssuePresenter providePresenter() {
