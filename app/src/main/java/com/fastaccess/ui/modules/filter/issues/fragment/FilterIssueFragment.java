...
public class FilterIssueFragment
  ...
  @Override
  public void onSearch(final @NonNull String query, final boolean isOpen,
                       final boolean isIssue, final boolean isEnterprise) {
  ...
  @Override
  public void onItemClicked(final @NonNull Issue item) {
