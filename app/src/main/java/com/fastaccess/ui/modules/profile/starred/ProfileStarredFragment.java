...
public class ProfileStarredFragment
    extends BaseFragment<ProfileStarredMvp.View, ProfileStarredPresenter>
    implements ProfileStarredMvp.View {
  ...
  public static ProfileStarredFragment newInstance(final
  ...
  @NonNull
  @Override
  public ProfileStarredPresenter providePresenter() {
  ...
  @Override
  public void onUpdateCount(final int starredCount) {
