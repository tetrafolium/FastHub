...
@Getter
class UserPagerPresenter
    extends BasePresenter<UserPagerMvp.View> implements UserPagerMvp.Presenter {
  ...
  @Override
  public void onCheckBlocking(final @NonNull String login) {
    makeRestCall(
  ...
  @Override
  public void checkOrgMembership(final @NonNull String org) {
    makeRestCall(RestProvider.getOrgService(isEnterprise())
                     .isMember(org, Login.getUser().getLogin()),
                 booleanResponse -> sendToView(view -> {
  ...
  @Override
  public void onBlockUser(final @NonNull String login) {
    if (isUserBlocked()) {
      onUnblockUser(login);
    } else {
  ...
  @Override
  public void onUnblockUser(final @NonNull String login) {
