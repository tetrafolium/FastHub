...
class UserPagerPresenter
  ...
  @Override
  public void onCheckBlocking(@NonNull String login) {
    makeRestCall(
  ...
  @Override
  public void checkOrgMembership(@NonNull String org) {
  ...
  @Override
  public void onBlockUser(@NonNull String login) {
    if (isUserBlocked()) {
      onUnblockUser(login);
    } else {
  ...
  @Override
  public void onUnblockUser(@NonNull String login) {
