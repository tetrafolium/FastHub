...
public class NestedCoordinatorLayout
    extends CoordinatorLayout implements NestedScrollingChild {
  ...
  @Override
  public void onNestedPreScroll(final View target, final int dx, final int dy,
                                final int[] consumed) {
  ...
  @Override
  public boolean onNestedPreFling(final View target, final float velocityX,
  ...
  @Override
  public boolean onNestedFling(final View target, final float velocityX,
