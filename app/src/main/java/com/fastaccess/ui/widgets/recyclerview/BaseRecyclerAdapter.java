...
public abstract class BaseRecyclerAdapter<
  ...
  protected BaseRecyclerAdapter(@NonNull List<M> data) { this(data, null); }
  ...
  public M getItemByPosition(int position) { return data.get(position); }

  public M getItem(int position) { return data.get(position); }

  public int getItem(M t) { return data.indexOf(t); }
  ...
  private void onShowGuide(
      @NonNull VH holder,
      int position) { // give the flexibility to other adapters to override this
