...
public class ListDialogView<O extends Parcelable> extends BaseDialogFragment
  ...
  @Override
  public void onItemClick(int position, View v, O item) {
  ...
  @Override
  public void onItemLongClick(int position, View v, O item) {}

  public void initArguments(@NonNull String title,
                            @NonNull ArrayList<O> objects) {
