...
public class ListDialogView<O extends Parcelable> extends BaseDialogFragment
    implements BaseViewHolder.OnItemClickListener<O> {
  ...
  @Override
  public void onItemClick(final int position, final View v, final O item) {
  ...
  @Override
  public void onItemLongClick(final int position, final View v, final O item) {}

  public void initArguments(final @NonNull String title,
                            final @NonNull ArrayList<O> objects) {
