...
public class ColorGenerator {
  ...
  static {
    MATERIAL = create(Arrays.asList(
        0xff1976d2, 0xff00838f, 0xff512da8, 0xff2e7d32, 0xff283593, 0xff01579b,
        0xffc51162, 0xff6a1b9a, 0xffd50000, 0xff00695c));
    MATERIAL_DARK = create(Arrays.asList(
        0xffffc107, 0xffffc400, 0xff2196f3, 0xff2979ff, 0xffa1887f, 0xff4dd0e1,
        0xff00acc1, 0xffe64a19, 0xff9575cd, 0xff66bb6a));
  }
  ...
  private ColorGenerator(final List<Integer> colorList) { colors = colorList; }
  ...
  @ColorInt
  public static int getColor(final @NonNull Context context,
