...
public abstract class BaseViewHolder<T> extends RecyclerView.ViewHolder
  ...
  public static View getView(@NonNull ViewGroup parent,
                             @LayoutRes int layoutRes) {
    return LayoutInflater.from(parent.getContext())
        .inflate(layoutRes, parent, false);
  }

  protected BaseViewHolder(@NonNull View itemView) { this(itemView, null); }
  ...
  public void onClick(View v) {
    if (adapter != null && adapter.getListener() != null) {
      ...
      if (position != RecyclerView.NO_POSITION &&
        ...
        adapter.getListener().onItemClick(position, v,
  ...
  public boolean onLongClick(View v) {
    if (adapter != null && adapter.getListener() != null) {
      ...
      if (position != RecyclerView.NO_POSITION &&
          position < adapter.getItemCount())
        adapter.getListener().onItemLongClick(position, v,
                                              adapter.getItem(position));
    }
    return true;
  }
