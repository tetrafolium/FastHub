...
public class SpannableBuilder extends SpannableStringBuilder {
  ...
  public static SpannableBuilder builder() { return new SpannableBuilder(); }
  ...
  @Override
  public SpannableBuilder append(final char text) {
    if (text != 0)
      super.append(text);
    return this;
  }
  ...
  @Override
  public SpannableBuilder append(final CharSequence text) {
    if (text != null)
      super.append(text);
    return this;
  }
  ...
  public SpannableBuilder foreground(final CharSequence text,
  ...
  public SpannableBuilder foreground(final char text,
                                     final @ColorInt int color) {
    return append(text, new ForegroundColorSpan(color));
  }
  ...
  public SpannableBuilder clickable(final CharSequence text,
                                    final View.OnClickListener listener) {
    if (!InputHelper.isEmpty(text))
