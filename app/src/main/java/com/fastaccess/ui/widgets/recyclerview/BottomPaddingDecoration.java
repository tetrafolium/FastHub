...
class BottomPaddingDecoration extends RecyclerView.ItemDecoration {
  ...
  private BottomPaddingDecoration(final @NonNull Context context) {
    this(ViewHelper.toPx(context, context.getResources().getDimensionPixelSize(
                                      R.dimen.fab_spacing)));
  }
  ...
  @Override
  public void getItemOffsets(final @NonNull Rect outRect, final View view,
    ...
    } else if (parent.getLayoutManager() instanceof
