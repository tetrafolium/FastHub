...
public class MessageDialogView extends BaseBottomSheetDialog {
  ...
  public void onClick(final @NonNull View view) {
    if (callback != null) {
      ...
      callback.onMessageDialogActionClicked(view.getId() == R.id.ok,
                                            getArguments().getBundle("bundle"));
    }
    dismiss();
  }
    ...
    if (extra != null) {
      ...
      if (yesNo) {
        ...
        if (hideButtons) {
          ...
          if (!InputHelper.isEmpty(secondaryExtra))
            cancel.setText(secondaryExtra);
  ...
  @NonNull
  public static MessageDialogView newInstance(final @NonNull String bundleTitle,
                                              final @NonNull String bundleMsg) {
  ...
  public static MessageDialogView newInstance(final @NonNull String bundleTitle,
    ...
    messageDialogView.setArguments(
        getBundle(bundleTitle, bundleMsg, isMarkDown, bundle, false));
    return messageDialogView;
  }

  @NonNull
  public static MessageDialogView
  newInstance(final @NonNull String bundleTitle,
              final @NonNull String bundleMsg, final boolean isMarkDown,
              final boolean hideCancel, final @Nullable Bundle bundle) {
    MessageDialogView messageDialogView = new MessageDialogView();
    messageDialogView.setArguments(
        getBundle(bundleTitle, bundleMsg, isMarkDown, bundle, hideCancel));
    return messageDialogView;
  }
  ...
  private static Bundle getBundle(final String bundleTitle,
                                  final String bundleMsg,
                                  final boolean isMarkDown, final Bundle bundle,
                                  final boolean hideCancel) {
  ...
  @NonNull
  public static Bundle getYesNoBundle(final @NonNull Context context) {
    return Bundler.start()
