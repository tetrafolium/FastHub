...
public class MessageDialogView extends BaseBottomSheetDialog {
  ...
  @NonNull
  public static MessageDialogView newInstance(@NonNull String bundleTitle,
                                              @NonNull String bundleMsg) {
  ...
  newInstance(@NonNull String bundleTitle, @NonNull String bundleMsg,
  ...
  public static MessageDialogView
  newInstance(@NonNull String bundleTitle, @NonNull String bundleMsg,
              boolean isMarkDown, @Nullable Bundle bundle) {
  ...
  public static MessageDialogView
  newInstance(@NonNull String bundleTitle, @NonNull String bundleMsg,
              boolean isMarkDown, boolean hideCancel, @Nullable Bundle bundle) {
    MessageDialogView messageDialogView = new MessageDialogView();
    messageDialogView.setArguments(
  ...
  private static Bundle getBundle(String bundleTitle, String bundleMsg,
                                  boolean isMarkDown, Bundle bundle,
                                  boolean hideCancel) {
