...
public class AvatarLayout extends FrameLayout {
  ...
  @OnClick(R.id.avatar)
  void onClick(final @NonNull View view) {
  ...
  public AvatarLayout(final @NonNull Context context) { super(context); }
  ...
  public AvatarLayout(final @NonNull Context context,
                      final @Nullable AttributeSet attrs,
                      final @AttrRes int defStyleAttr,
                      final @StyleRes int defStyleRes) {
  ...
  public void setUrl(final @Nullable String url, final @Nullable String login,
                     final boolean isOrg, final boolean isEnterprise) {
  ...
  public void setUrl(final @Nullable String url, final @Nullable String login,
    ...
    Glide.with(getContext())
        .load(url)
        .fallback(ContextCompat.getDrawable(getContext(),
                                            R.drawable.ic_fasthub_mascot))
        .diskCacheStrategy(DiskCacheStrategy.ALL)
        .signature(new ObjectKey(
            reload ? String.valueOf(System.currentTimeMillis()) : "0"))
        .dontAnimate()
        .into(avatar);
  }
