 ...
 * <p>
 * recyclerview which will showParentOrSelf/showParentOrSelf itself base on
 * adapter
 */
public class DynamicRecyclerView extends RecyclerView {
  ...
  public DynamicRecyclerView(@NonNull Context context) { this(context, null); }
  ...
  public void hideProgress(@NonNull StateLayout view) { view.hideProgress(); }

  public void showProgress(@NonNull StateLayout view) { view.showProgress(); }
  ...
  public void addNormalSpacingDivider() { addDivider(); }
