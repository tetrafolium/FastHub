...
public class AutoLinearLayout extends FrameLayout {
   ...
   */
  private void updateChildPositionVertical(int parentHeight, int totalSize,
                                           int column, int maxChildWidth) {
   ...
   */
  private void updateChildPositionHorizontal(int parentWidth, int totalSize,
                                             int row, int maxChildHeight) {
    for (int i = 0; i < mListPositions.size(); i++) {
      ViewPosition pos = mListPositions.get(i);
      final View child = getChildAt(i);
  ...
  private void updateLeftPositionByGravity(ViewPosition pos, int size,
                                           int gravity) {
  ...
  private void updateTopPositionByGravity(ViewPosition pos, int size,
                                          int gravity) {
