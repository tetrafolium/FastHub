...
public class DiffLineSpan
  ...
  private DiffLineSpan(int color) { this.color = color; }
  ...
  private void apply(TextPaint paint) { paint.setTypeface(Typeface.MONOSPACE); }
  ...
  getSpannable(@Nullable String text, @ColorInt int patchAdditionColor,
