...
public class FloatingActionButtonBehavior
  ...
  private static final String TAG =
      FloatingActionButtonBehavior.class.getSimpleName();
  private int navigationBarHeight = 0;

  public FloatingActionButtonBehavior() { super(); }

  public FloatingActionButtonBehavior(final Context context,
  ...
  @Override
  public void
  onAttachedToLayoutParams(@NonNull final CoordinatorLayout.LayoutParams lp) {
  ...
  @Override
  public boolean
  onDependentViewChanged(@NonNull final CoordinatorLayout parent,
    ...
    int bottomMargin = (params.bottomMargin + params.rightMargin) -
    ...
    for (View dep : list) {
      if (Snackbar.SnackbarLayout.class.isInstance(dep)) {
        ...
        t2 = navigation.getTranslationY() - navigation.getHeight() +
             bottomMargin;
        t += t2;
        result = true;
