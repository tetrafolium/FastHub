...
public class DatesUtils {
  ...
  public static int getWeekDayFromDate(final int year, final int month,
                                       final int day) {
   ...
   */
  @SuppressLint("WrongConstant")
  public static String getShortMonthName(final int year, final int month,
                                         final int day) {
    Calendar calendar = Calendar.getInstance();
    calendar.set(year, month - 1, day);
    calendar.add(Calendar.SECOND, 0);
   ...
   */
  @SuppressLint("WrongConstant")
  public static boolean isFirstWeekOfMount(final int year, final int month,
                                           final int day) {
    Calendar calendar = Calendar.getInstance();
    calendar.set(year, month - 1, day);
    calendar.add(Calendar.SECOND, 0);
   ...
   */
  @SuppressLint("WrongConstant")
  public static boolean isFirstDayOfWeek(final int year, final int month,
                                         final int day) {
    Calendar calendar = Calendar.getInstance();
    calendar.set(year, month - 1, day);
    calendar.add(Calendar.SECOND, 0);
