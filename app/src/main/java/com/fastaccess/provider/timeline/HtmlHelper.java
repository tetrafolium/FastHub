...
public class HtmlHelper {
  ...
  public static void htmlIntoTextView(@NonNull TextView textView,
                                      @NonNull String html, int width) {
  ...
  @ColorInt
  public static int getWindowBackground(@PrefGetter.ThemeType int theme) {
