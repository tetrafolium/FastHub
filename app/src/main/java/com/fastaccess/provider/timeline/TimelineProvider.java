...
public class TimelineProvider {
  ...
  getStyledEvents(final @NonNull GenericEvent issueEventModel,
  ...
  private static void appendReviews(final @NonNull GenericEvent issueEventModel,
                                    final @NonNull IssueEventType event,
                                    final
  ...
  @NonNull
  private static CharSequence getDate(final @Nullable Date date) {
    return ParseDateFormat.getTimeAgo(date);
  }

  @NonNull
  private static String substring(final @Nullable String value) {
    if (value == null) {
      return "";
    }
    if (value.length() <= 7)
