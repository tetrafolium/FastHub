...
public class CommentsHelper {
  ...
  public static boolean isOwner(@NonNull String currentLogin,
                                @NonNull String repoOwner,
                                @NonNull String commentUser) {
  ...
  @NonNull
  public static ArrayList<String> getUsers(@NonNull List<Comment> comments) {
  ...
  getUsersByTimeline(@NonNull List<TimelineModel> comments) {
    return Stream.of(comments)
  ...
  public static void
  appendEmojies(@NonNull ReactionsModel reaction, @NonNull TextView thumbsUp,
                @NonNull TextView thumbsUpReaction,
                @NonNull TextView thumbsDown,
