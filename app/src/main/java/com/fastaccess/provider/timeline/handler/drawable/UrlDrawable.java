...
class UrlDrawable extends BitmapDrawable implements Drawable.Callback {
  ...
  @Override
  public void scheduleDrawable(final @NonNull Drawable who,
                               final @NonNull Runnable what, final long when) {
    if (getCallback() != null) {
  ...
  @Override
  public void unscheduleDrawable(final @NonNull Drawable who,
                                 final @NonNull Runnable what) {
    if (getCallback() != null) {
