...
public class PreTagHandler extends PreHandler {
  ...
  public void handleTagNode(TagNode node, SpannableStringBuilder builder,
    ...
    if (isPre) {
      ...
      builder.append("\n");
      builder.setSpan(new CodeBackgroundRoundedSpan(color), start,
      ...
      builder.setSpan(new BackgroundColorSpan(color), stringStart, stringEnd,
                      SPAN_EXCLUSIVE_EXCLUSIVE);
      if (theme == PrefGetter.LIGHT) {
        builder.setSpan(new ForegroundColorSpan(Color.RED), stringStart,
                        stringEnd, SPAN_EXCLUSIVE_EXCLUSIVE);
      }
      builder.setSpan(new TypefaceSpan("monospace"), stringStart, stringEnd,
                      SPAN_EXCLUSIVE_EXCLUSIVE);
    }
  }
}
