...
public class MarkDownProvider {
  ...
  protected static void render(@NonNull TextView textView, String markdown,
                               int width) {
  ...
  public static void addPhoto(@NonNull EditText editText, @NonNull String title,
                              @NonNull String link) {
  ...
  public static void addLink(@NonNull EditText editText, @NonNull String title,
                             @NonNull String link) {
    String result = "[" + InputHelper.toString(title) + "](" +
                    InputHelper.toString(link) + ")";
    insertAtCursor(editText, result);
  ...
  private static boolean hasNewLine(@NonNull String source,
                                    int selectionStart) {
    try {
      if (source.isEmpty())
        return true;
  ...
  public static void insertAtCursor(@NonNull EditText editText,
                                    @NonNull String text) {
