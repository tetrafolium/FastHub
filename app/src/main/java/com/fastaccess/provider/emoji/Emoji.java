...
public class Emoji {
   ...
   */
  protected Emoji(final String description, final boolean supportsFitzpatrick,
                  final List<String> aliases, final List<String> tags,
                  final byte... bytes) {
    ...
    try {
      ...
      for (int offset = 0; offset < stringLength;) {
        ...
        pointCodes[count] =
            String.format(Locale.getDefault(), "&#%d;", codePoint);
   ...
   */
  public boolean supportsFitzpatrick() { return this.supportsFitzpatrick; }
   ...
   */
  public String getHtmlDecimal() { return this.htmlDec; }
   ...
   */
  public String getHtmlHexidecimal() { return this.getHtmlHexadecimal(); }
   ...
   * @return the HTML hexadecimal representation
   */
  public String getHtmlHexadecimal() { return this.htmlHex; }
  ...
  public String toString() {
    return "Emoji{"
        ...
        ", aliases=" + aliases + ", tags=" + tags + ", unicode='" + unicode +
