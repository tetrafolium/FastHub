...
public class EmojiTrie {
   ...
   * matches prefix of an emoji &lt;/li&gt; &lt;li&gt; Matches.IMPOSSIBLE if
   * char sequence matches no emoji or prefix of an emoji &lt;/li&gt;
   */
  ...
  public enum Matches {
    ...
    public boolean exactMatch() { return this == EXACTLY; }

    public boolean impossibleMatch() { return this == IMPOSSIBLE; }

    public boolean possibleMatch() { return this == POSSIBLY; }
  }
  ...
  private class Node {
    ...
    private void setEmoji(Emoji emoji) { this.emoji = emoji; }

    private Emoji getEmoji() { return emoji; }

    private boolean hasChild(char child) { return children.containsKey(child); }

    private void addChild(char child) { children.put(child, new Node()); }

    private Node getChild(char child) { return children.get(child); }

    private boolean isEndOfEmoji() { return emoji != null; }
  }
}
