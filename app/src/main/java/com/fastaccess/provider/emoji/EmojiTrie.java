...
public class EmojiTrie {
  ...
  private class Node {
    ...
    private void setEmoji(final Emoji emoji) { this.emoji = emoji; }
    ...
    private void addChild(final char child) { children.put(child, new Node()); }

    private Node getChild(final char child) { return children.get(child); }
