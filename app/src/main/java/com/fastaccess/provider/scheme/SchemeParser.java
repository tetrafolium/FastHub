...
public class SchemeParser {
  ...
  public static void launchUri(@NonNull Context context, @NonNull Uri data,
                               boolean showRepoBtn, boolean newDocument) {
    Logger.e(data);
  ...
  @Nullable
  private static Intent convert(@NonNull Context context, Uri data,
                                boolean showRepoBtn) {
    if (data == null)
      return null;
  ...
  @Nullable
  private static Intent getIntentForURI(@NonNull Context context,
                                        @NonNull Uri data,
                                        boolean showRepoBtn) {
  ...
  @Nullable
  private static Intent getPullRequestIntent(@NonNull Context context,
                                             @NonNull Uri uri,
                                             boolean showRepoBtn) {
    List<String> segments = uri.getPathSegments();
  ...
  @Nullable
  private static Intent getIssueIntent(@NonNull Context context,
                                       @NonNull Uri uri, boolean showRepoBtn) {
    List<String> segments = uri.getPathSegments();
    if (segments == null || segments.size() < 3)
      return null;
    String owner = null;
  ...
  @Nullable
  private static Intent getRepoProject(@NonNull Context context,
                                       @NonNull Uri uri) {
    List<String> segments = uri.getPathSegments();
    if (segments == null || segments.size() < 3)
      return null;
   ...
   */
  @Nullable
  private static Intent getGeneralRepo(@NonNull Context context,
                                       @NonNull Uri uri) {
  ...
  @Nullable
  private static Intent getCommits(@NonNull Context context, @NonNull Uri uri,
                                   boolean showRepoBtn) {
  ...
  @Nullable
  private static Intent getCommit(@NonNull Context context, @NonNull Uri uri,
                                  boolean showRepoBtn) {
    List<String> segments = Stream.of(uri.getPathSegments())
                                .filter(value
                                        -> !value.equalsIgnoreCase("api") ||
  ...
  @Nullable
  private static Intent getRepoIssueIntent(@NonNull Context context,
                                           @NonNull Uri uri) {
    List<String> segments = uri.getPathSegments();
    if (segments != null && segments.size() == 3 &&
  ...
  @Nullable
  private static Intent getRepoPullRequestIntent(@NonNull Context context,
                                                 @NonNull Uri uri) {
    List<String> segments = uri.getPathSegments();
    if (segments != null && segments.size() == 3 &&
  ...
  @Nullable
  private static Intent getReleases(@NonNull Context context, @NonNull Uri uri,
                                    boolean isEnterprise) {
    List<String> segments = uri.getPathSegments();
  ...
  @Nullable
  private static Intent getTrending(@NonNull Context context,
                                    @NonNull Uri uri) {
    List<String> segments = uri.getPathSegments();
    if (segments != null && !segments.isEmpty()) {
   ...
   */
  @Nullable
  private static Intent getCreateIssueIntent(@NonNull Context context,
                                             @NonNull Uri uri) {
    List<String> segments = uri.getPathSegments();
  ...
  @Nullable
  private static Intent getGistFile(@NonNull Context context,
                                    @NonNull Uri uri) {
  ...
  @Nullable
  private static Intent getSearchIntent(@NonNull Context context,
                                        @NonNull Uri uri) {
    List<String> segments = uri.getPathSegments();
