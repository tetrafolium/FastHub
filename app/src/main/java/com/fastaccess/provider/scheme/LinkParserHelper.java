...
public class LinkParserHelper {
  ...
  @SafeVarargs
  static <T> Optional<T> returnNonNull(@NonNull T... t) {
    return Stream.of(t).filter(ObjectsCompat::nonNull).findFirst();
  }

  @NonNull
  static Uri getBlobBuilder(@NonNull Uri uri) {
  ...
  @NonNull
  public static String getEndpoint(@NonNull String url) {
  ...
  @NonNull
  private static String getEnterpriseUrl(@NonNull String url) {
  ...
  public static String getEnterpriseGistUrl(@NonNull String url,
  ...
  @Nullable
  public static String getGistId(@NonNull Uri uri) {
    String gistId = null;
