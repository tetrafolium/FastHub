...
public class NotificationSchedulerJobTask extends JobService {
  ...
  public static void scheduleJob(@NonNull Context context, int duration,
                                 boolean cancel) {
  ...
  private void
  onNotifyUser(@NonNull List<Notification> notificationThreadModels,
               JobParameters job) {
  ...
  private void finishJob(JobParameters job) { jobFinished(job, false); }

  private void showNotificationWithoutComment(Context context, int accentColor,
                                              Notification thread,
                                              String iconUrl) {
    withoutComments(thread, context, accentColor);
  }

  private void withoutComments(Notification thread, Context context,
                               int accentColor) {
  ...
  private void withComments(Comment comment, Context context,
                            Notification thread, int accentColor) {
    android.app.Notification toAdd =
  ...
  getSummaryGroupNotification(@NonNull Notification thread, int accentColor,
                              boolean toNotificationActivity) {
  ...
  getNotification(@NonNull String title, @NonNull String message,
