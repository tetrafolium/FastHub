...
public class GithubActionService extends IntentService {
  ...
  public static void startForRepo(@NonNull Context context,
                                  @NonNull String login, @NonNull String repo,
                                  @GitActionType int type,
  ...
  public static void startForGist(@NonNull Context context, @NonNull String id,
                                  @GitActionType int type,
                                  boolean isEnterprise) {
    Intent intent =
        new Intent(context.getApplicationContext(), GithubActionService.class);
