...
public class GithubActionService extends IntentService {
  ...
  @interface GitActionType {}

  public static void startForRepo(final @NonNull Context context,
                                  final @NonNull String login,
                                  final @NonNull String repo,
                                  final @GitActionType int type,
                                  final boolean isEnterprise) {
    Intent intent =
        new Intent(context.getApplicationContext(), GithubActionService.class);
  ...
  public static void startForGist(final @NonNull Context context,
  ...
  public GithubActionService() { super(GithubActionService.class.getName()); }
  ...
  private void forkRepo(final @Nullable String id, final @Nullable String login,
                        final boolean isEnterprise) {
  ...
  private void starRepo(final @Nullable String id, final @Nullable String login,
                        final boolean isEnterprise) {
    if (id != null && login != null) {
  ...
  private void unStarGist(final @Nullable String id,
                          final boolean isEnterprise) {
    if (id != null) {
  ...
  private void unStarRepo(final @Nullable String id,
  ...
  private void unWatchRepo(final @Nullable String id,
                           final @Nullable String login,
                           final boolean isEnterprise) {
    if (id != null && login != null) {
  ...
  private void watchRepo(final @Nullable String id,
                         final @Nullable String login,
                         final boolean isEnterprise) {
    if (id != null && login != null) {
  ...
  private NotificationCompat.Builder getNotification(final
  ...
  private void showNotification(final @NonNull String msg) {
    getNotificationManager().notify(msg.hashCode(),
                                    getNotification(msg).build());
  }
