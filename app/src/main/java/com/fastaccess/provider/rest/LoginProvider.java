...
public class LoginProvider {
  ...
  private static OkHttpClient provideOkHttpClient(final
  ...
  private static Retrofit provideRetrofit(final @Nullable String authToken,
                                          final @Nullable String otp,
                                          final
                                          @Nullable String enterpriseUrl) {
    return new Retrofit.Builder()
        .baseUrl(InputHelper.isEmpty(enterpriseUrl)
                     ? BuildConfig.REST_URL
                     : LinkParserHelper.getEndpoint(enterpriseUrl))
  ...
  @NonNull
  public static LoginRestService
  getLoginRestService(final @NonNull String authToken,
                      final @Nullable String otp,
                      final @Nullable String endpoint) {
    return provideRetrofit(authToken, otp, endpoint)
        .create(LoginRestService.class);
  }
}
