...
public class RestProvider {
  ...
  private static Retrofit provideRetrofit(final boolean enterprise) {
    return new Retrofit.Builder()
        .baseUrl(
            enterprise && PrefGetter.isEnterprise()
  ...
  public static void downloadFile(final @NonNull Context context,
  ...
  public static void downloadFile(final @NonNull Context context,
    ...
    try {
      ...
      String authToken = isEnterprise ? PrefGetter.getEnterpriseToken()
                                      : PrefGetter.getToken();
      if (!TextUtils.isEmpty(authToken)) {
        request.addRequestHeader("Authorization", authToken.startsWith("Basic")
                                                      ? authToken
                                                      : "token " + authToken);
      }
  ...
  @NonNull
  public static UserRestService getUserService(final boolean enterprise) {
    return provideRetrofit(enterprise).create(UserRestService.class);
  }

  @NonNull
  public static GistService getGistService(final boolean enterprise) {
    return provideRetrofit(enterprise).create(GistService.class);
  }

  @NonNull
  public static RepoService getRepoService(final boolean enterprise) {
    return provideRetrofit(enterprise).create(RepoService.class);
  }

  @NonNull
  public static IssueService getIssueService(final boolean enterprise) {
    return provideRetrofit(enterprise).create(IssueService.class);
  }

  @NonNull
  public static PullRequestService
  getPullRequestService(final boolean enterprise) {
    return provideRetrofit(enterprise).create(PullRequestService.class);
  }

  @NonNull
  public static NotificationService
  getNotificationService(final boolean enterprise) {
    return provideRetrofit(enterprise).create(NotificationService.class);
  }

  @NonNull
  public static ReactionsService getReactionsService(final boolean enterprise) {
    return provideRetrofit(enterprise).create(ReactionsService.class);
  }

  @NonNull
  public static OrganizationService getOrgService(final boolean enterprise) {
    return provideRetrofit(enterprise).create(OrganizationService.class);
  }

  @NonNull
  public static ReviewService getReviewService(final boolean enterprise) {
  ...
  @NonNull
  public static SearchService getSearchService(final boolean enterprise) {
  ...
  public static SlackService getSlackService() {
    return new Retrofit.Builder()
        .baseUrl(
            "https://ok13pknpj4.execute-api.eu-central-1.amazonaws.com/prod/")
        .addConverterFactory(new GithubResponseConverter(gson))
        .addCallAdapterFactory(RxJava2CallAdapterFactory.create())
        .build()
  ...
  @NonNull
  public static ContentService getContentService(final boolean enterprise) {
    return provideRetrofit(enterprise).create(ContentService.class);
  }

  @NonNull
  public static ProjectsService getProjectsService(final boolean enterprise) {
    return provideRetrofit(enterprise).create(ProjectsService.class);
  }

  @Nullable
  public static GitHubErrorResponse
  getErrorResponse(final @NonNull Throwable throwable) {
  ...
  public static void clearHttpClient() { okHttpClient = null; }
}
