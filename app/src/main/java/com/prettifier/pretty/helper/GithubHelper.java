...
public class GithubHelper {
  ...
  @NonNull
  public static String generateContent(@NonNull Context context,
  ...
  @NonNull
  private static String parseReadme(@NonNull String source,
                                    @NonNull String baseUrl, boolean isWiki) {
  ...
  @NonNull
  private static String getParsedHtml(@NonNull String source, String owner,
                                      String repoName, String builder,
                                      String baseLinkUrl, boolean isWiki) {
  ...
  @NonNull
  private static String mergeContent(@NonNull Context context,
                                     @NonNull String source, boolean dark) {
    return "<html>\n"
        + "\n"
        + "<head>\n"
        + "    <meta charset=\"UTF-8\">\n"
  ...
  @NonNull
  private static String getStyle(boolean dark) {
    return dark ? "./github_dark.css" : "./github.css";
  }

  @NonNull
  private static String getCodeStyle(@NonNull Context context, boolean isDark) {
    if (!isDark)
      return "";
  ...
  @NonNull
  private static String getCodeBackgroundColor(@NonNull Context context) {
