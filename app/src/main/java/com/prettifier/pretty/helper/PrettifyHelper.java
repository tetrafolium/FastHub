...
public class PrettifyHelper {
  ...
  @NonNull
  private static String getHtmlContent(@NonNull String css,
                                       @NonNull String text, boolean wrap,
                                       boolean isDark) {
    return "<!DOCTYPE html>\n"
        + "<html>\n"
        + "<head>\n"
  ...
  @NonNull
  public static String generateContent(@NonNull String source, boolean isDark,
                                       boolean wrap) {
  ...
  @NonNull
  private static String getStyle(boolean isDark) {
